...
}`,CS=[new Y(1,0,0),new Y(-1,0,0),new Y(0,1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1)],RS=[new Y(0,-1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1),new Y(0,-1,0),new Y(0,-1,0)],qu=new xt,Ur=new Y,Eo=new Y;function PS(n,e,t){let i=new Fh;const r=new ot,s=new ot,a=new _t,o=new Gg,l=new kg,u={},c=t.maxTextureSize,f={[Si]:Wt,[Wt]:Si,[Xn]:Xn},h=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ot},radius:{value:4}},vertexShader:AS,fragmentShader:wS}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new xn;_.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new ni(_,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$s;let d=this.type;this.render=function(D,P,B){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||D.length===0)return;D.type===Dm&&(We("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),D.type=$s);const x=n.getRenderTarget(),E=n.getActiveCubeFace(),R=n.getActiveMipmapLevel(),U=n.state;U.setBlending(Yn),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const O=d!==this.type;O&&P.traverse(function(Z){Z.material&&(Array.isArray(Z.material)?Z.material.forEach(J=>J.needsUpdate=!0):Z.material.needsUpdate=!0)});for(let Z=0,J=D.length;Z<J;Z++){const q=D[Z],z=q.shadow;if(z===void 0){We("WebGLShadowMap:",q,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const G=z.getFrameExtents();if(r.multiply(G),s.copy(z.mapSize),(r.x>c||r.y>c)&&(r.x>c&&(s.x=Math.floor(c/G.x),r.x=s.x*G.x,z.mapSize.x=s.x),r.y>c&&(s.y=Math.floor(c/G.y),r.y=s.y*G.y,z.mapSize.y=s.y)),z.map===null||O===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Or){if(q.isPointLight){We("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Pn(r.x,r.y,{format:vr,type:Qn,minFilter:Pt,magFilter:Pt,generateMipmaps:!1}),z.map.texture.name=q.name+".shadowMap",z.map.depthTexture=new ls(r.x,r.y,Tn),z.map.depthTexture.name=q.name+".shadowMapDepth",z.map.depthTexture.format=ei,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Tt,z.map.depthTexture.magFilter=Tt}else{q.isPointLight?(z.map=new Nh(r.x),z.map.depthTexture=new Vg(r.x,Dn)):(z.map=new Pn(r.x,r.y),z.map.depthTexture=new ls(r.x,r.y,Dn)),z.map.depthTexture.name=q.name+".shadowMap",z.map.depthTexture.format=ei;const ce=n.state.buffers.depth.getReversed();this.type===$s?(z.map.depthTexture.compareFunction=ce?ac:sc,z.map.depthTexture.minFilter=Pt,z.map.depthTexture.magFilter=Pt):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Tt,z.map.depthTexture.magFilter=Tt)}z.camera.updateProjectionMatrix()}const re=z.map.isWebGLCubeRenderTarget?6:1;for(let ce=0;ce<re;ce++){if(z.map.isWebGLCubeRenderTarget)n.setRenderTarget(z.map,ce),n.clear();else{ce===0&&(n.setRenderTarget(z.map),n.clear());const he=z.getViewport(ce);a.set(s.x*he.x,s.y*he.y,s.x*he.z,s.y*he.w),U.viewport(a)}if(q.isPointLight){const he=z.camera,me=z.matrix,le=q.distance||he.far;le!==he.far&&(he.far=le,he.updateProjectionMatrix()),Ur.setFromMatrixPosition(q.matrixWorld),he.position.copy(Ur),Eo.copy(he.position),Eo.add(CS[ce]),he.up.copy(RS[ce]),he.lookAt(Eo),he.updateMatrixWorld(),me.makeTranslation(-Ur.x,-Ur.y,-Ur.z),qu.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),z._frustum.setFromProjectionMatrix(qu,he.coordinateSystem,he.reversedDepth)}else z.updateMatrices(q);i=z.getFrustum(),y(P,B,z.camera,q,this.type)}z.isPointLightShadow!==!0&&this.type===Or&&b(z,B),z.needsUpdate=!1}d=this.type,g.needsUpdate=!1,n.setRenderTarget(x,E,R)};function b(D,P){const B=e.update(v);h.defines.VSM_SAMPLES!==D.blurSamples&&(h.defines.VSM_SAMPLES=D.blurSamples,p.defines.VSM_SAMPLES=D.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),D.mapPass===null&&(D.mapPass=new Pn(r.x,r.y,{format:vr,type:Qn})),h.uniforms.shadow_pass.value=D.map.depthTexture,h.uniforms.resolution.value=D.mapSize,h.uniforms.radius.value=D.radius,n.setRenderTarget(D.mapPass),n.clear(),n.renderBufferDirect(P,null,B,h,v,null),p.uniforms.shadow_pass.value=D.mapPass.texture,p.uniforms.resolution.value=D.mapSize,p.uniforms.radius.value=D.radius,n.setRenderTarget(D.map),n.clear(),n.renderBufferDirect(P,null,B,p,v,null)}function A(D,P,B,x){let E=null;const R=B.isPointLight===!0?D.customDistanceMaterial:D.customDepthMaterial;if(R!==void 0)E=R;else if(E=B.isPointLight===!0?l:o,n.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const U=E.uuid,O=P.uuid;let Z=u[U];Z===void 0&&(Z={},u[U]=Z);let J=Z[O];J===void 0&&(J=E.clone(),Z[O]=J,P.addEventListener("dispose",w)),E=J}if(E.visible=P.visible,E.wireframe=P.wireframe,x===Or?E.side=P.shadowSide!==null?P.shadowSide:P.side:E.side=P.shadowSide!==null?P.shadowSide:f[P.side],E.alphaMap=P.alphaMap,E.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,E.map=P.map,E.clipShadows=P.clipShadows,E.clippingPlanes=P.clippingPlanes,E.clipIntersection=P.clipIntersection,E.displacementMap=P.displacementMap,E.displacementScale=P.displacementScale,E.displacementBias=P.displacementBias,E.wireframeLinewidth=P.wireframeLinewidth,E.linewidth=P.linewidth,B.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const U=n.properties.get(E);U.light=B}return E}function y(D,P,B,x,E){if(D.visible===!1)return;if(D.layers.test(P.layers)&&(D.isMesh||D.isLine||D.isPoints)&&(D.castShadow||D.receiveShadow&&E===Or)&&(!D.frustumCulled||i.intersectsObject(D))){D.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,D.matrixWorld);const O=e.update(D),Z=D.material;if(Array.isArray(Z)){const J=O.groups;for(let q=0,z=J.length;q<z;q++){const G=J[q],re=Z[G.materialIndex];if(re&&re.visible){const ce=A(D,re,x,E);D.onBeforeShadow(n,D,P,B,O,ce,G),n.renderBufferDirect(B,null,O,ce,D,G),D.onAfterShadow(n,D,P,B,O,ce,G)}}}else if(Z.visible){const J=A(D,Z,x,E);D.onBeforeShadow(n,D,P,B,O,J,null),n.renderBufferDirect(B,null,O,J,D,null),D.onAfterShadow(n,D,P,B,O,J,null)}}const U=D.children;for(let O=0,Z=U.length;O<Z;O++)y(U[O],P,B,x,E)}function w(D){D.target.removeEventListener("dispose",w);for(const B in u){const x=u[B],E=D.target.uuid;E in x&&(x[E].dispose(),delete x[E])}}}const DS={[zo]:Vo,[Ho]:Wo,[Go]:Xo,[_r]:ko,[Vo]:zo,[Wo]:Ho,[Xo]:Go,[ko]:_r};function LS(n,e){function t(){let N=!1;const Ce=new _t;let ge=null;const De=new _t(0,0,0,0);return{setMask:function(pe){ge!==pe&&!N&&(n.colorMask(pe,pe,pe,pe),ge=pe)},setLocked:function(pe){N=pe},setClear:function(pe,oe,Se,ke,ut){ut===!0&&(pe*=ke,oe*=ke,Se*=ke),Ce.set(pe,oe,Se,ke),De.equals(Ce)===!1&&(n.clearColor(pe,oe,Se,ke),De.copy(Ce))},reset:function(){N=!1,ge=null,De.set(-1,0,0,0)}}}function i(){let N=!1,Ce=!1,ge=null,De=null,pe=null;return{setReversed:function(oe){if(Ce!==oe){const Se=e.get("EXT_clip_control");oe?Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.ZERO_TO_ONE_EXT):Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.NEGATIVE_ONE_TO_ONE_EXT),Ce=oe;const ke=pe;pe=null,this.setClear(ke)}},getReversed:function(){return Ce},setTest:function(oe){oe?ne(n.DEPTH_TEST):Me(n.DEPTH_TEST)},setMask:function(oe){ge!==oe&&!N&&(n.depthMask(oe),ge=oe)},setFunc:function(oe){if(Ce&&(oe=DS[oe]),De!==oe){switch(oe){case zo:n.depthFunc(n.NEVER);break;case Vo:n.depthFunc(n.ALWAYS);break;case Ho:n.depthFunc(n.LESS);break;case _r:n.depthFunc(n.LEQUAL);break;case Go:n.depthFunc(n.EQUAL);break;case ko:n.depthFunc(n.GEQUAL);break;case Wo:n.depthFunc(n.GREATER);break;case Xo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}De=oe}},setLocked:function(oe){N=oe},setClear:function(oe){pe!==oe&&(Ce&&(oe=1-oe),n.clearDepth(oe),pe=oe)},reset:function(){N=!1,ge=null,De=null,pe=null,Ce=!1}}}function r(){let N=!1,Ce=null,ge=null,De=null,pe=null,oe=null,Se=null,ke=null,ut=null;return{setTest:function(it){N||(it?ne(n.STENCIL_TEST):Me(n.STENCIL_TEST))},setMask:function(it){Ce!==it&&!N&&(n.stencilMask(it),Ce=it)},setFunc:function(it,vn,In){(ge!==it||De!==vn||pe!==In)&&(n.stencilFunc(it,vn,In),ge=it,De=vn,pe=In)},setOp:function(it,vn,In){(oe!==it||Se!==vn||ke!==In)&&(n.stencilOp(it,vn,In),oe=it,Se=vn,ke=In)},setLocked:function(it){N=it},setClear:function(it){ut!==it&&(n.clearStencil(it),ut=it)},reset:function(){N=!1,Ce=null,ge=null,De=null,pe=null,oe=null,Se=null,ke=null,ut=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let c={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,b=null,A=null,y=null,w=null,D=null,P=new nt(0,0,0),B=0,x=!1,E=null,R=null,U=null,O=null,Z=null;const J=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,z=0;const G=n.getParameter(n.VERSION);G.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(G)[1]),q=z>=1):G.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),q=z>=2);let re=null,ce={};const he=n.getParameter(n.SCISSOR_BOX),me=n.getParameter(n.VIEWPORT),le=new _t().fromArray(he),Oe=new _t().fromArray(me);function Be(N,Ce,ge,De){const pe=new Uint8Array(4),oe=n.createTexture();n.bindTexture(N,oe),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Se=0;Se<ge;Se++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(Ce,0,n.RGBA,1,1,De,0,n.RGBA,n.UNSIGNED_BYTE,pe):n.texImage2D(Ce+Se,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,pe);return oe}const k={};k[n.TEXTURE_2D]=Be(n.TEXTURE_2D,n.TEXTURE_2D,1),k[n.TEXTURE_CUBE_MAP]=Be(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),k[n.TEXTURE_2D_ARRAY]=Be(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),k[n.TEXTURE_3D]=Be(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ne(n.DEPTH_TEST),a.setFunc(_r),K(!1),ie(Zc),ne(n.CULL_FACE),V(Yn);function ne(N){c[N]!==!0&&(n.enable(N),c[N]=!0)}function Me(N){c[N]!==!1&&(n.disable(N),c[N]=!1)}function Ue(N,Ce){return f[N]!==Ce?(n.bindFramebuffer(N,Ce),f[N]=Ce,N===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=Ce),N===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=Ce),!0):!1}function _e(N,Ce){let ge=p,De=!1;if(N){ge=h.get(Ce),ge===void 0&&(ge=[],h.set(Ce,ge));const pe=N.textures;if(ge.length!==pe.length||ge[0]!==n.COLOR_ATTACHMENT0){for(let oe=0,Se=pe.length;oe<Se;oe++)ge[oe]=n.COLOR_ATTACHMENT0+oe;ge.length=pe.length,De=!0}}else ge[0]!==n.BACK&&(ge[0]=n.BACK,De=!0);De&&n.drawBuffers(ge)}function we(N){return _!==N?(n.useProgram(N),_=N,!0):!1}const C={[Oi]:n.FUNC_ADD,[Im]:n.FUNC_SUBTRACT,[Um]:n.FUNC_REVERSE_SUBTRACT};C[Nm]=n.MIN,C[Fm]=n.MAX;const L={[Om]:n.ZERO,[Bm]:n.ONE,[zm]:n.SRC_COLOR,[Oo]:n.SRC_ALPHA,[Xm]:n.SRC_ALPHA_SATURATE,[km]:n.DST_COLOR,[Hm]:n.DST_ALPHA,[Vm]:n.ONE_MINUS_SRC_COLOR,[Bo]:n.ONE_MINUS_SRC_ALPHA,[Wm]:n.ONE_MINUS_DST_COLOR,[Gm]:n.ONE_MINUS_DST_ALPHA,[qm]:n.CONSTANT_COLOR,[Ym]:n.ONE_MINUS_CONSTANT_COLOR,[$m]:n.CONSTANT_ALPHA,[Km]:n.ONE_MINUS_CONSTANT_ALPHA};function V(N,Ce,ge,De,pe,oe,Se,ke,ut,it){if(N===Yn){v===!0&&(Me(n.BLEND),v=!1);return}if(v===!1&&(ne(n.BLEND),v=!0),N!==Lm){if(N!==g||it!==x){if((d!==Oi||y!==Oi)&&(n.blendEquation(n.FUNC_ADD),d=Oi,y=Oi),it)switch(N){case pr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFunc(n.ONE,n.ONE);break;case Jc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Qc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Qe("WebGLState: Invalid blending: ",N);break}else switch(N){case pr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Jc:Qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Qc:Qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qe("WebGLState: Invalid blending: ",N);break}b=null,A=null,w=null,D=null,P.set(0,0,0),B=0,g=N,x=it}return}pe=pe||Ce,oe=oe||ge,Se=Se||De,(Ce!==d||pe!==y)&&(n.blendEquationSeparate(C[Ce],C[pe]),d=Ce,y=pe),(ge!==b||De!==A||oe!==w||Se!==D)&&(n.blendFuncSeparate(L[ge],L[De],L[oe],L[Se]),b=ge,A=De,w=oe,D=Se),(ke.equals(P)===!1||ut!==B)&&(n.blendColor(ke.r,ke.g,ke.b,ut),P.copy(ke),B=ut),g=N,x=!1}function ee(N,Ce){N.side===Xn?Me(n.CULL_FACE):ne(n.CULL_FACE);let ge=N.side===Wt;Ce&&(ge=!ge),K(ge),N.blending===pr&&N.transparent===!1?V(Yn):V(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),s.setMask(N.colorWrite);const De=N.stencilWrite;o.setTest(De),De&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ue(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ne(n.SAMPLE_ALPHA_TO_COVERAGE):Me(n.SAMPLE_ALPHA_TO_COVERAGE)}function K(N){E!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),E=N)}function ie(N){N!==Rm?(ne(n.CULL_FACE),N!==R&&(N===Zc?n.cullFace(n.BACK):N===Pm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Me(n.CULL_FACE),R=N}function T(N){N!==U&&(q&&n.lineWidth(N),U=N)}function ue(N,Ce,ge){N?(ne(n.POLYGON_OFFSET_FILL),(O!==Ce||Z!==ge)&&(n.polygonOffset(Ce,ge),O=Ce,Z=ge)):Me(n.POLYGON_OFFSET_FILL)}function se(N){N?ne(n.SCISSOR_TEST):Me(n.SCISSOR_TEST)}function te(N){N===void 0&&(N=n.TEXTURE0+J-1),re!==N&&(n.activeTexture(N),re=N)}function ae(N,Ce,ge){ge===void 0&&(re===null?ge=n.TEXTURE0+J-1:ge=re);let De=ce[ge];De===void 0&&(De={type:void 0,texture:void 0},ce[ge]=De),(De.type!==N||De.texture!==Ce)&&(re!==ge&&(n.activeTexture(ge),re=ge),n.bindTexture(N,Ce||k[N]),De.type=N,De.texture=Ce)}function S(){const N=ce[re];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function m(){try{n.compressedTexImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function I(){try{n.compressedTexImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function X(){try{n.texSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Q(){try{n.texSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Te(){try{n.compressedTexSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function de(){try{n.texStorage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Re(){try{n.texStorage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Ne(){try{n.texImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function fe(){try{n.texImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function ve(N){le.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),le.copy(N))}function Ee(N){Oe.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),Oe.copy(N))}function Pe(N,Ce){let ge=u.get(Ce);ge===void 0&&(ge=new WeakMap,u.set(Ce,ge));let De=ge.get(N);De===void 0&&(De=n.getUniformBlockIndex(Ce,N.name),ge.set(N,De))}function xe(N,Ce){const De=u.get(Ce).get(N);l.get(Ce)!==De&&(n.uniformBlockBinding(Ce,De,N.__bindingPointIndex),l.set(Ce,De))}function Xe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},re=null,ce={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,b=null,A=null,y=null,w=null,D=null,P=new nt(0,0,0),B=0,x=!1,E=null,R=null,U=null,O=null,Z=null,le.set(0,0,n.canvas.width,n.canvas.height),Oe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ne,disable:Me,bindFramebuffer:Ue,drawBuffers:_e,useProgram:we,setBlending:V,setMaterial:ee,setFlipSided:K,setCullFace:ie,setLineWidth:T,setPolygonOffset:ue,setScissorTest:se,activeTexture:te,bindTexture:ae,unbindTexture:S,compressedTexImage2D:m,compressedTexImage3D:I,texImage2D:Ne,texImage3D:fe,updateUBOMapping:Pe,uniformBlockBinding:xe,texStorage2D:de,texStorage3D:Re,texSubImage2D:X,texSubImage3D:Q,compressedTexSubImage2D:W,compressedTexSubImage3D:Te,scissor:ve,viewport:Ee,reset:Xe}}function IS(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new ot,c=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,m){return p?new OffscreenCanvas(S,m):as("canvas")}function v(S,m,I){let X=1;const Q=ae(S);if((Q.width>I||Q.height>I)&&(X=I/Math.max(Q.width,Q.height)),X<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const W=Math.floor(X*Q.width),Te=Math.floor(X*Q.height);f===void 0&&(f=_(W,Te));const de=m?_(W,Te):f;return de.width=W,de.height=Te,de.getContext("2d").drawImage(S,0,0,W,Te),We("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+W+"x"+Te+")."),de}else return"data"in S&&We("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),S;return S}function g(S){return S.generateMipmaps}function d(S){n.generateMipmap(S)}function b(S){return S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?n.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function A(S,m,I,X,Q=!1){if(S!==null){if(n[S]!==void 0)return n[S];We("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let W=m;if(m===n.RED&&(I===n.FLOAT&&(W=n.R32F),I===n.HALF_FLOAT&&(W=n.R16F),I===n.UNSIGNED_BYTE&&(W=n.R8)),m===n.RED_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.R8UI),I===n.UNSIGNED_SHORT&&(W=n.R16UI),I===n.UNSIGNED_INT&&(W=n.R32UI),I===n.BYTE&&(W=n.R8I),I===n.SHORT&&(W=n.R16I),I===n.INT&&(W=n.R32I)),m===n.RG&&(I===n.FLOAT&&(W=n.RG32F),I===n.HALF_FLOAT&&(W=n.RG16F),I===n.UNSIGNED_BYTE&&(W=n.RG8)),m===n.RG_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.RG8UI),I===n.UNSIGNED_SHORT&&(W=n.RG16UI),I===n.UNSIGNED_INT&&(W=n.RG32UI),I===n.BYTE&&(W=n.RG8I),I===n.SHORT&&(W=n.RG16I),I===n.INT&&(W=n.RG32I)),m===n.RGB_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.RGB8UI),I===n.UNSIGNED_SHORT&&(W=n.RGB16UI),I===n.UNSIGNED_INT&&(W=n.RGB32UI),I===n.BYTE&&(W=n.RGB8I),I===n.SHORT&&(W=n.RGB16I),I===n.INT&&(W=n.RGB32I)),m===n.RGBA_INTEGER&&(I===n.UNSIGNED_BYTE&&(W=n.RGBA8UI),I===n.UNSIGNED_SHORT&&(W=n.RGBA16UI),I===n.UNSIGNED_INT&&(W=n.RGBA32UI),I===n.BYTE&&(W=n.RGBA8I),I===n.SHORT&&(W=n.RGBA16I),I===n.INT&&(W=n.RGBA32I)),m===n.RGB&&(I===n.UNSIGNED_INT_5_9_9_9_REV&&(W=n.RGB9_E5),I===n.UNSIGNED_INT_10F_11F_11F_REV&&(W=n.R11F_G11F_B10F)),m===n.RGBA){const Te=Q?ca:Ze.getTransfer(X);I===n.FLOAT&&(W=n.RGBA32F),I===n.HALF_FLOAT&&(W=n.RGBA16F),I===n.UNSIGNED_BYTE&&(W=Te===st?n.SRGB8_ALPHA8:n.RGBA8),I===n.UNSIGNED_SHORT_4_4_4_4&&(W=n.RGBA4),I===n.UNSIGNED_SHORT_5_5_5_1&&(W=n.RGB5_A1)}return(W===n.R16F||W===n.R32F||W===n.RG16F||W===n.RG32F||W===n.RGBA16F||W===n.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function y(S,m){let I;return S?m===null||m===Dn||m===ss?I=n.DEPTH24_STENCIL8:m===Tn?I=n.DEPTH32F_STENCIL8:m===rs&&(I=n.DEPTH24_STENCIL8,We("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Dn||m===ss?I=n.DEPTH_COMPONENT24:m===Tn?I=n.DEPTH_COMPONENT32F:m===rs&&(I=n.DEPTH_COMPONENT16),I}function w(S,m){return g(S)===!0||S.isFramebufferTexture&&S.minFilter!==Tt&&S.minFilter!==Pt?Math.log2(Math.max(m.width,m.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?m.mipmaps.length:1}function D(S){const m=S.target;m.removeEventListener("dispose",D),B(m),m.isVideoTexture&&c.delete(m)}function P(S){const m=S.target;m.removeEventListener("dispose",P),E(m)}function B(S){const m=i.get(S);if(m.__webglInit===void 0)return;const I=S.source,X=h.get(I);if(X){const Q=X[m.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&x(S),Object.keys(X).length===0&&h.delete(I)}i.remove(S)}function x(S){const m=i.get(S);n.deleteTexture(m.__webglTexture);const I=S.source,X=h.get(I);delete X[m.__cacheKey],a.memory.textures--}function E(S){const m=i.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),i.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(m.__webglFramebuffer[X]))for(let Q=0;Q<m.__webglFramebuffer[X].length;Q++)n.deleteFramebuffer(m.__webglFramebuffer[X][Q]);else n.deleteFramebuffer(m.__webglFramebuffer[X]);m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer[X])}else{if(Array.isArray(m.__webglFramebuffer))for(let X=0;X<m.__webglFramebuffer.length;X++)n.deleteFramebuffer(m.__webglFramebuffer[X]);else n.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&n.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let X=0;X<m.__webglColorRenderbuffer.length;X++)m.__webglColorRenderbuffer[X]&&n.deleteRenderbuffer(m.__webglColorRenderbuffer[X]);m.__webglDepthRenderbuffer&&n.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const I=S.textures;for(let X=0,Q=I.length;X<Q;X++){const W=i.get(I[X]);W.__webglTexture&&(n.deleteTexture(W.__webglTexture),a.memory.textures--),i.remove(I[X])}i.remove(S)}let R=0;function U(){R=0}function O(){const S=R;return S>=r.maxTextures&&We("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),R+=1,S}function Z(S){const m=[];return m.push(S.wrapS),m.push(S.wrapT),m.push(S.wrapR||0),m.push(S.magFilter),m.push(S.minFilter),m.push(S.anisotropy),m.push(S.internalFormat),m.push(S.format),m.push(S.type),m.push(S.generateMipmaps),m.push(S.premultiplyAlpha),m.push(S.flipY),m.push(S.unpackAlignment),m.push(S.colorSpace),m.join()}function J(S,m){const I=i.get(S);if(S.isVideoTexture&&se(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&I.__version!==S.version){const X=S.image;if(X===null)We("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)We("WebGLRenderer: Texture marked for update but image is incomplete");else{k(I,S,m);return}}else S.isExternalTexture&&(I.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,I.__webglTexture,n.TEXTURE0+m)}function q(S,m){const I=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&I.__version!==S.version){k(I,S,m);return}else S.isExternalTexture&&(I.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,I.__webglTexture,n.TEXTURE0+m)}function z(S,m){const I=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&I.__version!==S.version){k(I,S,m);return}t.bindTexture(n.TEXTURE_3D,I.__webglTexture,n.TEXTURE0+m)}function G(S,m){const I=i.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&I.__version!==S.version){ne(I,S,m);return}t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+m)}const re={[$o]:n.REPEAT,[qn]:n.CLAMP_TO_EDGE,[Ko]:n.MIRRORED_REPEAT},ce={[Tt]:n.NEAREST,[Jm]:n.NEAREST_MIPMAP_NEAREST,[Es]:n.NEAREST_MIPMAP_LINEAR,[Pt]:n.LINEAR,[Wa]:n.LINEAR_MIPMAP_NEAREST,[zi]:n.LINEAR_MIPMAP_LINEAR},he={[ng]:n.NEVER,[og]:n.ALWAYS,[ig]:n.LESS,[sc]:n.LEQUAL,[rg]:n.EQUAL,[ac]:n.GEQUAL,[sg]:n.GREATER,[ag]:n.NOTEQUAL};function me(S,m){if(m.type===Tn&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===Pt||m.magFilter===Wa||m.magFilter===Es||m.magFilter===zi||m.minFilter===Pt||m.minFilter===Wa||m.minFilter===Es||m.minFilter===zi)&&We("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,re[m.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,re[m.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,re[m.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,ce[m.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,ce[m.minFilter]),m.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,he[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===Tt||m.minFilter!==Es&&m.minFilter!==zi||m.type===Tn&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function le(S,m){let I=!1;S.__webglInit===void 0&&(S.__webglInit=!0,m.addEventListener("dispose",D));const X=m.source;let Q=h.get(X);Q===void 0&&(Q={},h.set(X,Q));const W=Z(m);if(W!==S.__cacheKey){Q[W]===void 0&&(Q[W]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,I=!0),Q[W].usedTimes++;const Te=Q[S.__cacheKey];Te!==void 0&&(Q[S.__cacheKey].usedTimes--,Te.usedTimes===0&&x(m)),S.__cacheKey=W,S.__webglTexture=Q[W].texture}return I}function Oe(S,m,I){return Math.floor(Math.floor(S/I)/m)}function Be(S,m,I,X){const W=S.updateRanges;if(W.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,m.width,m.height,I,X,m.data);else{W.sort((fe,ve)=>fe.start-ve.start);let Te=0;for(let fe=1;fe<W.length;fe++){const ve=W[Te],Ee=W[fe],Pe=ve.start+ve.count,xe=Oe(Ee.start,m.width,4),Xe=Oe(ve.start,m.width,4);Ee.start<=Pe+1&&xe===Xe&&Oe(Ee.start+Ee.count-1,m.width,4)===xe?ve.count=Math.max(ve.count,Ee.start+Ee.count-ve.start):(++Te,W[Te]=Ee)}W.length=Te+1;const de=n.getParameter(n.UNPACK_ROW_LENGTH),Re=n.getParameter(n.UNPACK_SKIP_PIXELS),Ne=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,m.width);for(let fe=0,ve=W.length;fe<ve;fe++){const Ee=W[fe],Pe=Math.floor(Ee.start/4),xe=Math.ceil(Ee.count/4),Xe=Pe%m.width,N=Math.floor(Pe/m.width),Ce=xe,ge=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Xe),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),t.texSubImage2D(n.TEXTURE_2D,0,Xe,N,Ce,ge,I,X,m.data)}S.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,de),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Re),n.pixelStorei(n.UNPACK_SKIP_ROWS,Ne)}}function k(S,m,I){let X=n.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(X=n.TEXTURE_2D_ARRAY),m.isData3DTexture&&(X=n.TEXTURE_3D);const Q=le(S,m),W=m.source;t.bindTexture(X,S.__webglTexture,n.TEXTURE0+I);const Te=i.get(W);if(W.version!==Te.__version||Q===!0){t.activeTexture(n.TEXTURE0+I);const de=Ze.getPrimaries(Ze.workingColorSpace),Re=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Ne=m.colorSpace===pi||de===Re?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);let fe=v(m.image,!1,r.maxTextureSize);fe=te(m,fe);const ve=s.convert(m.format,m.colorSpace),Ee=s.convert(m.type);let Pe=A(m.internalFormat,ve,Ee,m.colorSpace,m.isVideoTexture);me(X,m);let xe;const Xe=m.mipmaps,N=m.isVideoTexture!==!0,Ce=Te.__version===void 0||Q===!0,ge=W.dataReady,De=w(m,fe);if(m.isDepthTexture)Pe=y(m.format===Vi,m.type),Ce&&(N?t.texStorage2D(n.TEXTURE_2D,1,Pe,fe.width,fe.height):t.texImage2D(n.TEXTURE_2D,0,Pe,fe.width,fe.height,0,ve,Ee,null));else if(m.isDataTexture)if(Xe.length>0){N&&Ce&&t.texStorage2D(n.TEXTURE_2D,De,Pe,Xe[0].width,Xe[0].height);for(let pe=0,oe=Xe.length;pe<oe;pe++)xe=Xe[pe],N?ge&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,ve,Ee,xe.data):t.texImage2D(n.TEXTURE_2D,pe,Pe,xe.width,xe.height,0,ve,Ee,xe.data);m.generateMipmaps=!1}else N?(Ce&&t.texStorage2D(n.TEXTURE_2D,De,Pe,fe.width,fe.height),ge&&Be(m,fe,ve,Ee)):t.texImage2D(n.TEXTURE_2D,0,Pe,fe.width,fe.height,0,ve,Ee,fe.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){N&&Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,De,Pe,Xe[0].width,Xe[0].height,fe.depth);for(let pe=0,oe=Xe.length;pe<oe;pe++)if(xe=Xe[pe],m.format!==dn)if(ve!==null)if(N){if(ge)if(m.layerUpdates.size>0){const Se=yu(xe.width,xe.height,m.format,m.type);for(const ke of m.layerUpdates){const ut=xe.data.subarray(ke*Se/xe.data.BYTES_PER_ELEMENT,(ke+1)*Se/xe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,ke,xe.width,xe.height,1,ve,ut)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,xe.width,xe.height,fe.depth,ve,xe.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,pe,Pe,xe.width,xe.height,fe.depth,0,xe.data,0,0);else We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?ge&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,xe.width,xe.height,fe.depth,ve,Ee,xe.data):t.texImage3D(n.TEXTURE_2D_ARRAY,pe,Pe,xe.width,xe.height,fe.depth,0,ve,Ee,xe.data)}else{N&&Ce&&t.texStorage2D(n.TEXTURE_2D,De,Pe,Xe[0].width,Xe[0].height);for(let pe=0,oe=Xe.length;pe<oe;pe++)xe=Xe[pe],m.format!==dn?ve!==null?N?ge&&t.compressedTexSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,ve,xe.data):t.compressedTexImage2D(n.TEXTURE_2D,pe,Pe,xe.width,xe.height,0,xe.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?ge&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,ve,Ee,xe.data):t.texImage2D(n.TEXTURE_2D,pe,Pe,xe.width,xe.height,0,ve,Ee,xe.data)}else if(m.isDataArrayTexture)if(N){if(Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,De,Pe,fe.width,fe.height,fe.depth),ge)if(m.layerUpdates.size>0){const pe=yu(fe.width,fe.height,m.format,m.type);for(const oe of m.layerUpdates){const Se=fe.data.subarray(oe*pe/fe.data.BYTES_PER_ELEMENT,(oe+1)*pe/fe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,oe,fe.width,fe.height,1,ve,Ee,Se)}m.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,ve,Ee,fe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Pe,fe.width,fe.height,fe.depth,0,ve,Ee,fe.data);else if(m.isData3DTexture)N?(Ce&&t.texStorage3D(n.TEXTURE_3D,De,Pe,fe.width,fe.height,fe.depth),ge&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,ve,Ee,fe.data)):t.texImage3D(n.TEXTURE_3D,0,Pe,fe.width,fe.height,fe.depth,0,ve,Ee,fe.data);else if(m.isFramebufferTexture){if(Ce)if(N)t.texStorage2D(n.TEXTURE_2D,De,Pe,fe.width,fe.height);else{let pe=fe.width,oe=fe.height;for(let Se=0;Se<De;Se++)t.texImage2D(n.TEXTURE_2D,Se,Pe,pe,oe,0,ve,Ee,null),pe>>=1,oe>>=1}}else if(Xe.length>0){if(N&&Ce){const pe=ae(Xe[0]);t.texStorage2D(n.TEXTURE_2D,De,Pe,pe.width,pe.height)}for(let pe=0,oe=Xe.length;pe<oe;pe++)xe=Xe[pe],N?ge&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,ve,Ee,xe):t.texImage2D(n.TEXTURE_2D,pe,Pe,ve,Ee,xe);m.generateMipmaps=!1}else if(N){if(Ce){const pe=ae(fe);t.texStorage2D(n.TEXTURE_2D,De,Pe,pe.width,pe.height)}ge&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Ee,fe)}else t.texImage2D(n.TEXTURE_2D,0,Pe,ve,Ee,fe);g(m)&&d(X),Te.__version=W.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function ne(S,m,I){if(m.image.length!==6)return;const X=le(S,m),Q=m.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+I);const W=i.get(Q);if(Q.version!==W.__version||X===!0){t.activeTexture(n.TEXTURE0+I);const Te=Ze.getPrimaries(Ze.workingColorSpace),de=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Re=m.colorSpace===pi||Te===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);const Ne=m.isCompressedTexture||m.image[0].isCompressedTexture,fe=m.image[0]&&m.image[0].isDataTexture,ve=[];for(let oe=0;oe<6;oe++)!Ne&&!fe?ve[oe]=v(m.image[oe],!0,r.maxCubemapSize):ve[oe]=fe?m.image[oe].image:m.image[oe],ve[oe]=te(m,ve[oe]);const Ee=ve[0],Pe=s.convert(m.format,m.colorSpace),xe=s.convert(m.type),Xe=A(m.internalFormat,Pe,xe,m.colorSpace),N=m.isVideoTexture!==!0,Ce=W.__version===void 0||X===!0,ge=Q.dataReady;let De=w(m,Ee);me(n.TEXTURE_CUBE_MAP,m);let pe;if(Ne){N&&Ce&&t.texStorage2D(n.TEXTURE_CUBE_MAP,De,Xe,Ee.width,Ee.height);for(let oe=0;oe<6;oe++){pe=ve[oe].mipmaps;for(let Se=0;Se<pe.length;Se++){const ke=pe[Se];m.format!==dn?Pe!==null?N?ge&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se,0,0,ke.width,ke.height,Pe,ke.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se,Xe,ke.width,ke.height,0,ke.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se,0,0,ke.width,ke.height,Pe,xe,ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se,Xe,ke.width,ke.height,0,Pe,xe,ke.data)}}}else{if(pe=m.mipmaps,N&&Ce){pe.length>0&&De++;const oe=ae(ve[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,De,Xe,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(fe){N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,ve[oe].width,ve[oe].height,Pe,xe,ve[oe].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Xe,ve[oe].width,ve[oe].height,0,Pe,xe,ve[oe].data);for(let Se=0;Se<pe.length;Se++){const ut=pe[Se].image[oe].image;N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se+1,0,0,ut.width,ut.height,Pe,xe,ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se+1,Xe,ut.width,ut.height,0,Pe,xe,ut.data)}}else{N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Pe,xe,ve[oe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Xe,Pe,xe,ve[oe]);for(let Se=0;Se<pe.length;Se++){const ke=pe[Se];N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se+1,0,0,Pe,xe,ke.image[oe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Se+1,Xe,Pe,xe,ke.image[oe])}}}g(m)&&d(n.TEXTURE_CUBE_MAP),W.__version=Q.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function Me(S,m,I,X,Q,W){const Te=s.convert(I.format,I.colorSpace),de=s.convert(I.type),Re=A(I.internalFormat,Te,de,I.colorSpace),Ne=i.get(m),fe=i.get(I);if(fe.__renderTarget=m,!Ne.__hasExternalTextures){const ve=Math.max(1,m.width>>W),Ee=Math.max(1,m.height>>W);Q===n.TEXTURE_3D||Q===n.TEXTURE_2D_ARRAY?t.texImage3D(Q,W,Re,ve,Ee,m.depth,0,Te,de,null):t.texImage2D(Q,W,Re,ve,Ee,0,Te,de,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,X,Q,fe.__webglTexture,0,T(m)):(Q===n.TEXTURE_2D||Q>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,X,Q,fe.__webglTexture,W),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ue(S,m,I){if(n.bindRenderbuffer(n.RENDERBUFFER,S),m.depthBuffer){const X=m.depthTexture,Q=X&&X.isDepthTexture?X.type:null,W=y(m.stencilBuffer,Q),Te=m.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;ue(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,T(m),W,m.width,m.height):I?n.renderbufferStorageMultisample(n.RENDERBUFFER,T(m),W,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,W,m.width,m.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Te,n.RENDERBUFFER,S)}else{const X=m.textures;for(let Q=0;Q<X.length;Q++){const W=X[Q],Te=s.convert(W.format,W.colorSpace),de=s.convert(W.type),Re=A(W.internalFormat,Te,de,W.colorSpace);ue(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,T(m),Re,m.width,m.height):I?n.renderbufferStorageMultisample(n.RENDERBUFFER,T(m),Re,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,Re,m.width,m.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function _e(S,m,I){const X=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=i.get(m.depthTexture);if(Q.__renderTarget=m,(!Q.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),X){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,m.depthTexture.addEventListener("dispose",D)),Q.__webglTexture===void 0){Q.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,Q.__webglTexture),me(n.TEXTURE_CUBE_MAP,m.depthTexture);const Ne=s.convert(m.depthTexture.format),fe=s.convert(m.depthTexture.type);let ve;m.depthTexture.format===ei?ve=n.DEPTH_COMPONENT24:m.depthTexture.format===Vi&&(ve=n.DEPTH24_STENCIL8);for(let Ee=0;Ee<6;Ee++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Ee,0,ve,m.width,m.height,0,Ne,fe,null)}}else J(m.depthTexture,0);const W=Q.__webglTexture,Te=T(m),de=X?n.TEXTURE_CUBE_MAP_POSITIVE_X+I:n.TEXTURE_2D,Re=m.depthTexture.format===Vi?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(m.depthTexture.format===ei)ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Re,de,W,0,Te):n.framebufferTexture2D(n.FRAMEBUFFER,Re,de,W,0);else if(m.depthTexture.format===Vi)ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Re,de,W,0,Te):n.framebufferTexture2D(n.FRAMEBUFFER,Re,de,W,0);else throw new Error("Unknown depthTexture format")}function we(S){const m=i.get(S),I=S.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==S.depthTexture){const X=S.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),X){const Q=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,X.removeEventListener("dispose",Q)};X.addEventListener("dispose",Q),m.__depthDisposeCallback=Q}m.__boundDepthTexture=X}if(S.depthTexture&&!m.__autoAllocateDepthBuffer)if(I)for(let X=0;X<6;X++)_e(m.__webglFramebuffer[X],S,X);else{const X=S.texture.mipmaps;X&&X.length>0?_e(m.__webglFramebuffer[0],S,0):_e(m.__webglFramebuffer,S,0)}else if(I){m.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[X]),m.__webglDepthbuffer[X]===void 0)m.__webglDepthbuffer[X]=n.createRenderbuffer(),Ue(m.__webglDepthbuffer[X],S,!1);else{const Q=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,W=m.__webglDepthbuffer[X];n.bindRenderbuffer(n.RENDERBUFFER,W),n.framebufferRenderbuffer(n.FRAMEBUFFER,Q,n.RENDERBUFFER,W)}}else{const X=S.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=n.createRenderbuffer(),Ue(m.__webglDepthbuffer,S,!1);else{const Q=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,W=m.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,W),n.framebufferRenderbuffer(n.FRAMEBUFFER,Q,n.RENDERBUFFER,W)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function C(S,m,I){const X=i.get(S);m!==void 0&&Me(X.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),I!==void 0&&we(S)}function L(S){const m=S.texture,I=i.get(S),X=i.get(m);S.addEventListener("dispose",P);const Q=S.textures,W=S.isWebGLCubeRenderTarget===!0,Te=Q.length>1;if(Te||(X.__webglTexture===void 0&&(X.__webglTexture=n.createTexture()),X.__version=m.version,a.memory.textures++),W){I.__webglFramebuffer=[];for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0){I.__webglFramebuffer[de]=[];for(let Re=0;Re<m.mipmaps.length;Re++)I.__webglFramebuffer[de][Re]=n.createFramebuffer()}else I.__webglFramebuffer[de]=n.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){I.__webglFramebuffer=[];for(let de=0;de<m.mipmaps.length;de++)I.__webglFramebuffer[de]=n.createFramebuffer()}else I.__webglFramebuffer=n.createFramebuffer();if(Te)for(let de=0,Re=Q.length;de<Re;de++){const Ne=i.get(Q[de]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=n.createTexture(),a.memory.textures++)}if(S.samples>0&&ue(S)===!1){I.__webglMultisampledFramebuffer=n.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let de=0;de<Q.length;de++){const Re=Q[de];I.__webglColorRenderbuffer[de]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,I.__webglColorRenderbuffer[de]);const Ne=s.convert(Re.format,Re.colorSpace),fe=s.convert(Re.type),ve=A(Re.internalFormat,Ne,fe,Re.colorSpace,S.isXRRenderTarget===!0),Ee=T(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ee,ve,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,I.__webglColorRenderbuffer[de])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(I.__webglDepthRenderbuffer=n.createRenderbuffer(),Ue(I.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(W){t.bindTexture(n.TEXTURE_CUBE_MAP,X.__webglTexture),me(n.TEXTURE_CUBE_MAP,m);for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0)for(let Re=0;Re<m.mipmaps.length;Re++)Me(I.__webglFramebuffer[de][Re],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Re);else Me(I.__webglFramebuffer[de],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);g(m)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Te){for(let de=0,Re=Q.length;de<Re;de++){const Ne=Q[de],fe=i.get(Ne);let ve=n.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ve=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ve,fe.__webglTexture),me(ve,Ne),Me(I.__webglFramebuffer,S,Ne,n.COLOR_ATTACHMENT0+de,ve,0),g(Ne)&&d(ve)}t.unbindTexture()}else{let de=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(de=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(de,X.__webglTexture),me(de,m),m.mipmaps&&m.mipmaps.length>0)for(let Re=0;Re<m.mipmaps.length;Re++)Me(I.__webglFramebuffer[Re],S,m,n.COLOR_ATTACHMENT0,de,Re);else Me(I.__webglFramebuffer,S,m,n.COLOR_ATTACHMENT0,de,0);g(m)&&d(de),t.unbindTexture()}S.depthBuffer&&we(S)}function V(S){const m=S.textures;for(let I=0,X=m.length;I<X;I++){const Q=m[I];if(g(Q)){const W=b(S),Te=i.get(Q).__webglTexture;t.bindTexture(W,Te),d(W),t.unbindTexture()}}}const ee=[],K=[];function ie(S){if(S.samples>0){if(ue(S)===!1){const m=S.textures,I=S.width,X=S.height;let Q=n.COLOR_BUFFER_BIT;const W=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Te=i.get(S),de=m.length>1;if(de)for(let Ne=0;Ne<m.length;Ne++)t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer);const Re=S.texture.mipmaps;Re&&Re.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let Ne=0;Ne<m.length;Ne++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(Q|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(Q|=n.STENCIL_BUFFER_BIT)),de){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Te.__webglColorRenderbuffer[Ne]);const fe=i.get(m[Ne]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,fe,0)}n.blitFramebuffer(0,0,I,X,0,0,I,X,Q,n.NEAREST),l===!0&&(ee.length=0,K.length=0,ee.push(n.COLOR_ATTACHMENT0+Ne),S.depthBuffer&&S.resolveDepthBuffer===!1&&(ee.push(W),K.push(W),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,K)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),de)for(let Ne=0;Ne<m.length;Ne++){t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.RENDERBUFFER,Te.__webglColorRenderbuffer[Ne]);const fe=i.get(m[Ne]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ne,n.TEXTURE_2D,fe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const m=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[m])}}}function T(S){return Math.min(r.maxSamples,S.samples)}function ue(S){const m=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function se(S){const m=a.render.frame;c.get(S)!==m&&(c.set(S,m),S.update())}function te(S,m){const I=S.colorSpace,X=S.format,Q=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||I!==Sr&&I!==pi&&(Ze.getTransfer(I)===st?(X!==dn||Q!==an)&&We("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qe("WebGLTextures: Unsupported texture color space:",I)),m}function ae(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(u.width=S.naturalWidth||S.width,u.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(u.width=S.displayWidth,u.height=S.displayHeight):(u.width=S.width,u.height=S.height),u}this.allocateTextureUnit=O,this.resetTextureUnits=U,this.setTexture2D=J,this.setTexture2DArray=q,this.setTexture3D=z,this.setTextureCube=G,this.rebindTextures=C,this.setupRenderTarget=L,this.updateRenderTargetMipmap=V,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=we,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=ue,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function US(n,e){function t(i,r=pi){let s;const a=Ze.getTransfer(r);if(i===an)return n.UNSIGNED_BYTE;if(i===ec)return n.UNSIGNED_SHORT_4_4_4_4;if(i===tc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===vh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Sh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===_h)return n.BYTE;if(i===xh)return n.SHORT;if(i===rs)return n.UNSIGNED_SHORT;if(i===Ql)return n.INT;if(i===Dn)return n.UNSIGNED_INT;if(i===Tn)return n.FLOAT;if(i===Qn)return n.HALF_FLOAT;if(i===Mh)return n.ALPHA;if(i===Eh)return n.RGB;if(i===dn)return n.RGBA;if(i===ei)return n.DEPTH_COMPONENT;if(i===Vi)return n.DEPTH_STENCIL;if(i===yh)return n.RED;if(i===nc)return n.RED_INTEGER;if(i===vr)return n.RG;if(i===ic)return n.RG_INTEGER;if(i===rc)return n.RGBA_INTEGER;if(i===Ks||i===js||i===Zs||i===Js)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ks)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ks)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jo||i===Zo||i===Jo||i===Qo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===jo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Zo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Jo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Qo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===el||i===tl||i===nl||i===il||i===rl||i===sl||i===al)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===el||i===tl)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===nl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===il)return s.COMPRESSED_R11_EAC;if(i===rl)return s.COMPRESSED_SIGNED_R11_EAC;if(i===sl)return s.COMPRESSED_RG11_EAC;if(i===al)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===ol||i===ll||i===cl||i===ul||i===fl||i===hl||i===dl||i===pl||i===ml||i===gl||i===_l||i===xl||i===vl||i===Sl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ol)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ll)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===cl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ul)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===fl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===hl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===dl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===pl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ml)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===gl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===_l)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===xl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===vl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Sl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ml||i===El||i===yl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Ml)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===El)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===yl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===bl||i===Tl||i===Al||i===wl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===bl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Tl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Al)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===wl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ss?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const NS=`
void main() {
