...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function Hx(n,e,t){const i=new Float32Array(Bi),r=new $(0,1,0);return new Ln({name:"SphericalGaussianBlur",defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ta(),fragmentShader:`
...
`)}const qv={[ch]:"Linear",[uh]:"Reinhard",[fh]:"Cineon",[hh]:"ACESFilmic",[ph]:"AgX",[mh]:"Neutral",[dh]:"Custom"};function Yv(n,e){const t=qv[e];return t===void 0?(We("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ws=new $;function $v(){Ze.getLuminanceCoefficients(Ws);const n=Ws.x.toFixed(4),e=Ws.y.toFixed(4),t=Ws.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const A=b+g+a,y=b+d+o,w=Fu(r,r.VERTEX_SHADER,A),D=Fu(r,r.FRAGMENT_SHADER,y);r.attachShader(v,w),r.attachShader(v,D),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function R(I){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(v)||"",B=r.getShaderInfoLog(w)||"",V=r.getShaderInfoLog(D)||"",q=U.trim(),W=B.trim(),z=V.trim();let ee=!0,ce=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(ee=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,w,D);else{const ie=Bu(r,w,"vertex"),le=Bu(r,D,"fragment");Qe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,CS=[new $(1,0,0),new $(-1,0,0),new $(0,1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1)],RS=[new $(0,-1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1),new $(0,-1,0),new $(0,-1,0)],qu=new xt,Fr=new $,Eo=new $;function PS(n,e,t){let i=new Fh;const r=new ot,s=new ot,a=new _t,o=new Gg,l=new kg,u={},c=t.maxTextureSize,f={[Si]:Wt,[Wt]:Si,[Xn]:Xn},h=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ot},radius:{value:4}},vertexShader:AS,fragmentShader:wS}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new xn;_.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new ni(_,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$s;let d=this.type;this.render=function(D,R,O){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||D.length===0)return;D.type===Dm&&(We("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),D.type=$s);const x=n.getRenderTarget(),E=n.getActiveCubeFace(),I=n.getActiveMipmapLevel(),U=n.state;U.setBlending(Yn),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const B=d!==this.type;B&&R.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(q=>q.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,q=D.length;V<q;V++){const W=D[V],z=W.shadow;if(z===void 0){We("WebGLShadowMap:",W,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const ee=z.getFrameExtents();if(r.multiply(ee),s.copy(z.mapSize),(r.x>c||r.y>c)&&(r.x>c&&(s.x=Math.floor(c/ee.x),r.x=s.x*ee.x,z.mapSize.x=s.x),r.y>c&&(s.y=Math.floor(c/ee.y),r.y=s.y*ee.y,z.mapSize.y=s.y)),z.map===null||B===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Br){if(W.isPointLight){We("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Pn(r.x,r.y,{format:Mr,type:Qn,minFilter:Dt,magFilter:Dt,generateMipmaps:!1}),z.map.texture.name=W.name+".shadowMap",z.map.depthTexture=new ls(r.x,r.y,Tn),z.map.depthTexture.name=W.name+".shadowMapDepth",z.map.depthTexture.format=ei,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Tt,z.map.depthTexture.magFilter=Tt}else{W.isPointLight?(z.map=new Nh(r.x),z.map.depthTexture=new Vg(r.x,Dn)):(z.map=new Pn(r.x,r.y),z.map.depthTexture=new ls(r.x,r.y,Dn)),z.map.depthTexture.name=W.name+".shadowMap",z.map.depthTexture.format=ei;const ie=n.state.buffers.depth.getReversed();this.type===$s?(z.map.depthTexture.compareFunction=ie?ac:sc,z.map.depthTexture.minFilter=Dt,z.map.depthTexture.magFilter=Dt):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Tt,z.map.depthTexture.magFilter=Tt)}z.camera.updateProjectionMatrix()}const ce=z.map.isWebGLCubeRenderTarget?6:1;for(let ie=0;ie<ce;ie++){if(z.map.isWebGLCubeRenderTarget)n.setRenderTarget(z.map,ie),n.clear();else{ie===0&&(n.setRenderTarget(z.map),n.clear());const le=z.getViewport(ie);a.set(s.x*le.x,s.y*le.y,s.x*le.z,s.y*le.w),U.viewport(a)}if(W.isPointLight){const le=z.camera,Ie=z.matrix,me=W.distance||le.far;me!==le.far&&(le.far=me,le.updateProjectionMatrix()),Fr.setFromMatrixPosition(W.matrixWorld),le.position.copy(Fr),Eo.copy(le.position),Eo.add(CS[ie]),le.up.copy(RS[ie]),le.lookAt(Eo),le.updateMatrixWorld(),Ie.makeTranslation(-Fr.x,-Fr.y,-Fr.z),qu.multiplyMatrices(le.projectionMatrix,le.matrixWorldInverse),z._frustum.setFromProjectionMatrix(qu,le.coordinateSystem,le.reversedDepth)}else z.updateMatrices(W);i=z.getFrustum(),y(R,O,z.camera,W,this.type)}z.isPointLightShadow!==!0&&this.type===Br&&b(z,O),z.needsUpdate=!1}d=this.type,g.needsUpdate=!1,n.setRenderTarget(x,E,I)};function b(D,R){const O=e.update(v);h.defines.VSM_SAMPLES!==D.blurSamples&&(h.defines.VSM_SAMPLES=D.blurSamples,p.defines.VSM_SAMPLES=D.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),D.mapPass===null&&(D.mapPass=new Pn(r.x,r.y,{format:Mr,type:Qn})),h.uniforms.shadow_pass.value=D.map.depthTexture,h.uniforms.resolution.value=D.mapSize,h.uniforms.radius.value=D.radius,n.setRenderTarget(D.mapPass),n.clear(),n.renderBufferDirect(R,null,O,h,v,null),p.uniforms.shadow_pass.value=D.mapPass.texture,p.uniforms.resolution.value=D.mapSize,p.uniforms.radius.value=D.radius,n.setRenderTarget(D.map),n.clear(),n.renderBufferDirect(R,null,O,p,v,null)}function A(D,R,O,x){let E=null;const I=O.isPointLight===!0?D.customDistanceMaterial:D.customDepthMaterial;if(I!==void 0)E=I;else if(E=O.isPointLight===!0?l:o,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const U=E.uuid,B=R.uuid;let V=u[U];V===void 0&&(V={},u[U]=V);let q=V[B];q===void 0&&(q=E.clone(),V[B]=q,R.addEventListener("dispose",w)),E=q}if(E.visible=R.visible,E.wireframe=R.wireframe,x===Br?E.side=R.shadowSide!==null?R.shadowSide:R.side:E.side=R.shadowSide!==null?R.shadowSide:f[R.side],E.alphaMap=R.alphaMap,E.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,E.map=R.map,E.clipShadows=R.clipShadows,E.clippingPlanes=R.clippingPlanes,E.clipIntersection=R.clipIntersection,E.displacementMap=R.displacementMap,E.displacementScale=R.displacementScale,E.displacementBias=R.displacementBias,E.wireframeLinewidth=R.wireframeLinewidth,E.linewidth=R.linewidth,O.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const U=n.properties.get(E);U.light=O}return E}function y(D,R,O,x,E){if(D.visible===!1)return;if(D.layers.test(R.layers)&&(D.isMesh||D.isLine||D.isPoints)&&(D.castShadow||D.receiveShadow&&E===Br)&&(!D.frustumCulled||i.intersectsObject(D))){D.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,D.matrixWorld);const B=e.update(D),V=D.material;if(Array.isArray(V)){const q=B.groups;for(let W=0,z=q.length;W<z;W++){const ee=q[W],ce=V[ee.materialIndex];if(ce&&ce.visible){const ie=A(D,ce,x,E);D.onBeforeShadow(n,D,R,O,B,ie,ee),n.renderBufferDirect(O,null,B,ie,D,ee),D.onAfterShadow(n,D,R,O,B,ie,ee)}}}else if(V.visible){const q=A(D,V,x,E);D.onBeforeShadow(n,D,R,O,B,q,null),n.renderBufferDirect(O,null,B,q,D,null),D.onAfterShadow(n,D,R,O,B,q,null)}}const U=D.children;for(let B=0,V=U.length;B<V;B++)y(U[B],R,O,x,E)}function w(D){D.target.removeEventListener("dispose",w);for(const O in u){const x=u[O],E=D.target.uuid;E in x&&(x[E].dispose(),delete x[E])}}}const DS={[zo]:Vo,[Ho]:Wo,[Go]:Xo,[vr]:ko,[Vo]:zo,[Wo]:Ho,[Xo]:Go,[ko]:vr};function LS(n,e){function t(){let N=!1;const Ce=new _t;let _e=null;const Le=new _t(0,0,0,0);return{setMask:function(pe){_e!==pe&&!N&&(n.colorMask(pe,pe,pe,pe),_e=pe)},setLocked:function(pe){N=pe},setClear:function(pe,oe,Me,ke,ut){ut===!0&&(pe*=ke,oe*=ke,Me*=ke),Ce.set(pe,oe,Me,ke),Le.equals(Ce)===!1&&(n.clearColor(pe,oe,Me,ke),Le.copy(Ce))},reset:function(){N=!1,_e=null,Le.set(-1,0,0,0)}}}function i(){let N=!1,Ce=!1,_e=null,Le=null,pe=null;return{setReversed:function(oe){if(Ce!==oe){const Me=e.get("EXT_clip_control");oe?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),Ce=oe;const ke=pe;pe=null,this.setClear(ke)}},getReversed:function(){return Ce},setTest:function(oe){oe?Q(n.DEPTH_TEST):ge(n.DEPTH_TEST)},setMask:function(oe){_e!==oe&&!N&&(n.depthMask(oe),_e=oe)},setFunc:function(oe){if(Ce&&(oe=DS[oe]),Le!==oe){switch(oe){case zo:n.depthFunc(n.NEVER);break;case Vo:n.depthFunc(n.ALWAYS);break;case Ho:n.depthFunc(n.LESS);break;case vr:n.depthFunc(n.LEQUAL);break;case Go:n.depthFunc(n.EQUAL);break;case ko:n.depthFunc(n.GEQUAL);break;case Wo:n.depthFunc(n.GREATER);break;case Xo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Le=oe}},setLocked:function(oe){N=oe},setClear:function(oe){pe!==oe&&(Ce&&(oe=1-oe),n.clearDepth(oe),pe=oe)},reset:function(){N=!1,_e=null,Le=null,pe=null,Ce=!1}}}function r(){let N=!1,Ce=null,_e=null,Le=null,pe=null,oe=null,Me=null,ke=null,ut=null;return{setTest:function(it){N||(it?Q(n.STENCIL_TEST):ge(n.STENCIL_TEST))},setMask:function(it){Ce!==it&&!N&&(n.stencilMask(it),Ce=it)},setFunc:function(it,vn,In){(_e!==it||Le!==vn||pe!==In)&&(n.stencilFunc(it,vn,In),_e=it,Le=vn,pe=In)},setOp:function(it,vn,In){(oe!==it||Me!==vn||ke!==In)&&(n.stencilOp(it,vn,In),oe=it,Me=vn,ke=In)},setLocked:function(it){N=it},setClear:function(it){ut!==it&&(n.clearStencil(it),ut=it)},reset:function(){N=!1,Ce=null,_e=null,Le=null,pe=null,oe=null,Me=null,ke=null,ut=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let c={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,b=null,A=null,y=null,w=null,D=null,R=new nt(0,0,0),O=0,x=!1,E=null,I=null,U=null,B=null,V=null;const q=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,z=0;const ee=n.getParameter(n.VERSION);ee.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(ee)[1]),W=z>=1):ee.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(ee)[1]),W=z>=2);let ce=null,ie={};const le=n.getParameter(n.SCISSOR_BOX),Ie=n.getParameter(n.VIEWPORT),me=new _t().fromArray(le),he=new _t().fromArray(Ie);function xe(N,Ce,_e,Le){const pe=new Uint8Array(4),oe=n.createTexture();n.bindTexture(N,oe),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Me=0;Me<_e;Me++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(Ce,0,n.RGBA,1,1,Le,0,n.RGBA,n.UNSIGNED_BYTE,pe):n.texImage2D(Ce+Me,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,pe);return oe}const Y={};Y[n.TEXTURE_2D]=xe(n.TEXTURE_2D,n.TEXTURE_2D,1),Y[n.TEXTURE_CUBE_MAP]=xe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[n.TEXTURE_2D_ARRAY]=xe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Y[n.TEXTURE_3D]=xe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Q(n.DEPTH_TEST),a.setFunc(vr),Z(!1),re(Zc),Q(n.CULL_FACE),H(Yn);function Q(N){c[N]!==!0&&(n.enable(N),c[N]=!0)}function ge(N){c[N]!==!1&&(n.disable(N),c[N]=!1)}function Be(N,Ce){return f[N]!==Ce?(n.bindFramebuffer(N,Ce),f[N]=Ce,N===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=Ce),N===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=Ce),!0):!1}function be(N,Ce){let _e=p,Le=!1;if(N){_e=h.get(Ce),_e===void 0&&(_e=[],h.set(Ce,_e));const pe=N.textures;if(_e.length!==pe.length||_e[0]!==n.COLOR_ATTACHMENT0){for(let oe=0,Me=pe.length;oe<Me;oe++)_e[oe]=n.COLOR_ATTACHMENT0+oe;_e.length=pe.length,Le=!0}}else _e[0]!==n.BACK&&(_e[0]=n.BACK,Le=!0);Le&&n.drawBuffers(_e)}function De(N){return _!==N?(n.useProgram(N),_=N,!0):!1}const C={[Oi]:n.FUNC_ADD,[Im]:n.FUNC_SUBTRACT,[Um]:n.FUNC_REVERSE_SUBTRACT};C[Nm]=n.MIN,C[Fm]=n.MAX;const P={[Om]:n.ZERO,[Bm]:n.ONE,[zm]:n.SRC_COLOR,[Oo]:n.SRC_ALPHA,[Xm]:n.SRC_ALPHA_SATURATE,[km]:n.DST_COLOR,[Hm]:n.DST_ALPHA,[Vm]:n.ONE_MINUS_SRC_COLOR,[Bo]:n.ONE_MINUS_SRC_ALPHA,[Wm]:n.ONE_MINUS_DST_COLOR,[Gm]:n.ONE_MINUS_DST_ALPHA,[qm]:n.CONSTANT_COLOR,[Ym]:n.ONE_MINUS_CONSTANT_COLOR,[$m]:n.CONSTANT_ALPHA,[Km]:n.ONE_MINUS_CONSTANT_ALPHA};function H(N,Ce,_e,Le,pe,oe,Me,ke,ut,it){if(N===Yn){v===!0&&(ge(n.BLEND),v=!1);return}if(v===!1&&(Q(n.BLEND),v=!0),N!==Lm){if(N!==g||it!==x){if((d!==Oi||y!==Oi)&&(n.blendEquation(n.FUNC_ADD),d=Oi,y=Oi),it)switch(N){case gr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFunc(n.ONE,n.ONE);break;case Jc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Qc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Qe("WebGLState: Invalid blending: ",N);break}else switch(N){case gr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Jc:Qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Qc:Qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qe("WebGLState: Invalid blending: ",N);break}b=null,A=null,w=null,D=null,R.set(0,0,0),O=0,g=N,x=it}return}pe=pe||Ce,oe=oe||_e,Me=Me||Le,(Ce!==d||pe!==y)&&(n.blendEquationSeparate(C[Ce],C[pe]),d=Ce,y=pe),(_e!==b||Le!==A||oe!==w||Me!==D)&&(n.blendFuncSeparate(P[_e],P[Le],P[oe],P[Me]),b=_e,A=Le,w=oe,D=Me),(ke.equals(R)===!1||ut!==O)&&(n.blendColor(ke.r,ke.g,ke.b,ut),R.copy(ke),O=ut),g=N,x=!1}function te(N,Ce){N.side===Xn?ge(n.CULL_FACE):Q(n.CULL_FACE);let _e=N.side===Wt;Ce&&(_e=!_e),Z(_e),N.blending===gr&&N.transparent===!1?H(Yn):H(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),s.setMask(N.colorWrite);const Le=N.stencilWrite;o.setTest(Le),Le&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ue(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Q(n.SAMPLE_ALPHA_TO_COVERAGE):ge(n.SAMPLE_ALPHA_TO_COVERAGE)}function Z(N){E!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),E=N)}function re(N){N!==Rm?(Q(n.CULL_FACE),N!==I&&(N===Zc?n.cullFace(n.BACK):N===Pm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ge(n.CULL_FACE),I=N}function T(N){N!==U&&(W&&n.lineWidth(N),U=N)}function ue(N,Ce,_e){N?(Q(n.POLYGON_OFFSET_FILL),(B!==Ce||V!==_e)&&(n.polygonOffset(Ce,_e),B=Ce,V=_e)):ge(n.POLYGON_OFFSET_FILL)}function se(N){N?Q(n.SCISSOR_TEST):ge(n.SCISSOR_TEST)}function ne(N){N===void 0&&(N=n.TEXTURE0+q-1),ce!==N&&(n.activeTexture(N),ce=N)}function ae(N,Ce,_e){_e===void 0&&(ce===null?_e=n.TEXTURE0+q-1:_e=ce);let Le=ie[_e];Le===void 0&&(Le={type:void 0,texture:void 0},ie[_e]=Le),(Le.type!==N||Le.texture!==Ce)&&(ce!==_e&&(n.activeTexture(_e),ce=_e),n.bindTexture(N,Ce||Y[N]),Le.type=N,Le.texture=Ce)}function S(){const N=ie[ce];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function m(){try{n.compressedTexImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function L(){try{n.compressedTexImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function X(){try{n.texSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function J(){try{n.texSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function k(){try{n.compressedTexSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Ae(){try{n.compressedTexSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function de(){try{n.texStorage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Re(){try{n.texStorage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Fe(){try{n.texImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function fe(){try{n.texImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Se(N){me.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),me.copy(N))}function Ee(N){he.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),he.copy(N))}function Pe(N,Ce){let _e=u.get(Ce);_e===void 0&&(_e=new WeakMap,u.set(Ce,_e));let Le=_e.get(N);Le===void 0&&(Le=n.getUniformBlockIndex(Ce,N.name),_e.set(N,Le))}function ve(N,Ce){const Le=u.get(Ce).get(N);l.get(Ce)!==Le&&(n.uniformBlockBinding(Ce,Le,N.__bindingPointIndex),l.set(Ce,Le))}function Xe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},ce=null,ie={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,b=null,A=null,y=null,w=null,D=null,R=new nt(0,0,0),O=0,x=!1,E=null,I=null,U=null,B=null,V=null,me.set(0,0,n.canvas.width,n.canvas.height),he.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Q,disable:ge,bindFramebuffer:Be,drawBuffers:be,useProgram:De,setBlending:H,setMaterial:te,setFlipSided:Z,setCullFace:re,setLineWidth:T,setPolygonOffset:ue,setScissorTest:se,activeTexture:ne,bindTexture:ae,unbindTexture:S,compressedTexImage2D:m,compressedTexImage3D:L,texImage2D:Fe,texImage3D:fe,updateUBOMapping:Pe,uniformBlockBinding:ve,texStorage2D:de,texStorage3D:Re,texSubImage2D:X,texSubImage3D:J,compressedTexSubImage2D:k,compressedTexSubImage3D:Ae,scissor:Se,viewport:Ee,reset:Xe}}function IS(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new ot,c=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,m){return p?new OffscreenCanvas(S,m):as("canvas")}function v(S,m,L){let X=1;const J=ae(S);if((J.width>L||J.height>L)&&(X=L/Math.max(J.width,J.height)),X<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const k=Math.floor(X*J.width),Ae=Math.floor(X*J.height);f===void 0&&(f=_(k,Ae));const de=m?_(k,Ae):f;return de.width=k,de.height=Ae,de.getContext("2d").drawImage(S,0,0,k,Ae),We("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+k+"x"+Ae+")."),de}else return"data"in S&&We("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),S;return S}function g(S){return S.generateMipmaps}function d(S){n.generateMipmap(S)}function b(S){return S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?n.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function A(S,m,L,X,J=!1){if(S!==null){if(n[S]!==void 0)return n[S];We("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let k=m;if(m===n.RED&&(L===n.FLOAT&&(k=n.R32F),L===n.HALF_FLOAT&&(k=n.R16F),L===n.UNSIGNED_BYTE&&(k=n.R8)),m===n.RED_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.R8UI),L===n.UNSIGNED_SHORT&&(k=n.R16UI),L===n.UNSIGNED_INT&&(k=n.R32UI),L===n.BYTE&&(k=n.R8I),L===n.SHORT&&(k=n.R16I),L===n.INT&&(k=n.R32I)),m===n.RG&&(L===n.FLOAT&&(k=n.RG32F),L===n.HALF_FLOAT&&(k=n.RG16F),L===n.UNSIGNED_BYTE&&(k=n.RG8)),m===n.RG_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RG8UI),L===n.UNSIGNED_SHORT&&(k=n.RG16UI),L===n.UNSIGNED_INT&&(k=n.RG32UI),L===n.BYTE&&(k=n.RG8I),L===n.SHORT&&(k=n.RG16I),L===n.INT&&(k=n.RG32I)),m===n.RGB_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RGB8UI),L===n.UNSIGNED_SHORT&&(k=n.RGB16UI),L===n.UNSIGNED_INT&&(k=n.RGB32UI),L===n.BYTE&&(k=n.RGB8I),L===n.SHORT&&(k=n.RGB16I),L===n.INT&&(k=n.RGB32I)),m===n.RGBA_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RGBA8UI),L===n.UNSIGNED_SHORT&&(k=n.RGBA16UI),L===n.UNSIGNED_INT&&(k=n.RGBA32UI),L===n.BYTE&&(k=n.RGBA8I),L===n.SHORT&&(k=n.RGBA16I),L===n.INT&&(k=n.RGBA32I)),m===n.RGB&&(L===n.UNSIGNED_INT_5_9_9_9_REV&&(k=n.RGB9_E5),L===n.UNSIGNED_INT_10F_11F_11F_REV&&(k=n.R11F_G11F_B10F)),m===n.RGBA){const Ae=J?ca:Ze.getTransfer(X);L===n.FLOAT&&(k=n.RGBA32F),L===n.HALF_FLOAT&&(k=n.RGBA16F),L===n.UNSIGNED_BYTE&&(k=Ae===st?n.SRGB8_ALPHA8:n.RGBA8),L===n.UNSIGNED_SHORT_4_4_4_4&&(k=n.RGBA4),L===n.UNSIGNED_SHORT_5_5_5_1&&(k=n.RGB5_A1)}return(k===n.R16F||k===n.R32F||k===n.RG16F||k===n.RG32F||k===n.RGBA16F||k===n.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function y(S,m){let L;return S?m===null||m===Dn||m===ss?L=n.DEPTH24_STENCIL8:m===Tn?L=n.DEPTH32F_STENCIL8:m===rs&&(L=n.DEPTH24_STENCIL8,We("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Dn||m===ss?L=n.DEPTH_COMPONENT24:m===Tn?L=n.DEPTH_COMPONENT32F:m===rs&&(L=n.DEPTH_COMPONENT16),L}function w(S,m){return g(S)===!0||S.isFramebufferTexture&&S.minFilter!==Tt&&S.minFilter!==Dt?Math.log2(Math.max(m.width,m.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?m.mipmaps.length:1}function D(S){const m=S.target;m.removeEventListener("dispose",D),O(m),m.isVideoTexture&&c.delete(m)}function R(S){const m=S.target;m.removeEventListener("dispose",R),E(m)}function O(S){const m=i.get(S);if(m.__webglInit===void 0)return;const L=S.source,X=h.get(L);if(X){const J=X[m.__cacheKey];J.usedTimes--,J.usedTimes===0&&x(S),Object.keys(X).length===0&&h.delete(L)}i.remove(S)}function x(S){const m=i.get(S);n.deleteTexture(m.__webglTexture);const L=S.source,X=h.get(L);delete X[m.__cacheKey],a.memory.textures--}function E(S){const m=i.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),i.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(m.__webglFramebuffer[X]))for(let J=0;J<m.__webglFramebuffer[X].length;J++)n.deleteFramebuffer(m.__webglFramebuffer[X][J]);else n.deleteFramebuffer(m.__webglFramebuffer[X]);m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer[X])}else{if(Array.isArray(m.__webglFramebuffer))for(let X=0;X<m.__webglFramebuffer.length;X++)n.deleteFramebuffer(m.__webglFramebuffer[X]);else n.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&n.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let X=0;X<m.__webglColorRenderbuffer.length;X++)m.__webglColorRenderbuffer[X]&&n.deleteRenderbuffer(m.__webglColorRenderbuffer[X]);m.__webglDepthRenderbuffer&&n.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const L=S.textures;for(let X=0,J=L.length;X<J;X++){const k=i.get(L[X]);k.__webglTexture&&(n.deleteTexture(k.__webglTexture),a.memory.textures--),i.remove(L[X])}i.remove(S)}let I=0;function U(){I=0}function B(){const S=I;return S>=r.maxTextures&&We("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),I+=1,S}function V(S){const m=[];return m.push(S.wrapS),m.push(S.wrapT),m.push(S.wrapR||0),m.push(S.magFilter),m.push(S.minFilter),m.push(S.anisotropy),m.push(S.internalFormat),m.push(S.format),m.push(S.type),m.push(S.generateMipmaps),m.push(S.premultiplyAlpha),m.push(S.flipY),m.push(S.unpackAlignment),m.push(S.colorSpace),m.join()}function q(S,m){const L=i.get(S);if(S.isVideoTexture&&se(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&L.__version!==S.version){const X=S.image;if(X===null)We("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)We("WebGLRenderer: Texture marked for update but image is incomplete");else{Y(L,S,m);return}}else S.isExternalTexture&&(L.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,L.__webglTexture,n.TEXTURE0+m)}function W(S,m){const L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){Y(L,S,m);return}else S.isExternalTexture&&(L.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,L.__webglTexture,n.TEXTURE0+m)}function z(S,m){const L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){Y(L,S,m);return}t.bindTexture(n.TEXTURE_3D,L.__webglTexture,n.TEXTURE0+m)}function ee(S,m){const L=i.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&L.__version!==S.version){Q(L,S,m);return}t.bindTexture(n.TEXTURE_CUBE_MAP,L.__webglTexture,n.TEXTURE0+m)}const ce={[$o]:n.REPEAT,[qn]:n.CLAMP_TO_EDGE,[Ko]:n.MIRRORED_REPEAT},ie={[Tt]:n.NEAREST,[Jm]:n.NEAREST_MIPMAP_NEAREST,[Es]:n.NEAREST_MIPMAP_LINEAR,[Dt]:n.LINEAR,[Wa]:n.LINEAR_MIPMAP_NEAREST,[zi]:n.LINEAR_MIPMAP_LINEAR},le={[ng]:n.NEVER,[og]:n.ALWAYS,[ig]:n.LESS,[sc]:n.LEQUAL,[rg]:n.EQUAL,[ac]:n.GEQUAL,[sg]:n.GREATER,[ag]:n.NOTEQUAL};function Ie(S,m){if(m.type===Tn&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===Dt||m.magFilter===Wa||m.magFilter===Es||m.magFilter===zi||m.minFilter===Dt||m.minFilter===Wa||m.minFilter===Es||m.minFilter===zi)&&We("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,ce[m.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,ce[m.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,ce[m.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,ie[m.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,ie[m.minFilter]),m.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,le[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===Tt||m.minFilter!==Es&&m.minFilter!==zi||m.type===Tn&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function me(S,m){let L=!1;S.__webglInit===void 0&&(S.__webglInit=!0,m.addEventListener("dispose",D));const X=m.source;let J=h.get(X);J===void 0&&(J={},h.set(X,J));const k=V(m);if(k!==S.__cacheKey){J[k]===void 0&&(J[k]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,L=!0),J[k].usedTimes++;const Ae=J[S.__cacheKey];Ae!==void 0&&(J[S.__cacheKey].usedTimes--,Ae.usedTimes===0&&x(m)),S.__cacheKey=k,S.__webglTexture=J[k].texture}return L}function he(S,m,L){return Math.floor(Math.floor(S/L)/m)}function xe(S,m,L,X){const k=S.updateRanges;if(k.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,m.width,m.height,L,X,m.data);else{k.sort((fe,Se)=>fe.start-Se.start);let Ae=0;for(let fe=1;fe<k.length;fe++){const Se=k[Ae],Ee=k[fe],Pe=Se.start+Se.count,ve=he(Ee.start,m.width,4),Xe=he(Se.start,m.width,4);Ee.start<=Pe+1&&ve===Xe&&he(Ee.start+Ee.count-1,m.width,4)===ve?Se.count=Math.max(Se.count,Ee.start+Ee.count-Se.start):(++Ae,k[Ae]=Ee)}k.length=Ae+1;const de=n.getParameter(n.UNPACK_ROW_LENGTH),Re=n.getParameter(n.UNPACK_SKIP_PIXELS),Fe=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,m.width);for(let fe=0,Se=k.length;fe<Se;fe++){const Ee=k[fe],Pe=Math.floor(Ee.start/4),ve=Math.ceil(Ee.count/4),Xe=Pe%m.width,N=Math.floor(Pe/m.width),Ce=ve,_e=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Xe),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),t.texSubImage2D(n.TEXTURE_2D,0,Xe,N,Ce,_e,L,X,m.data)}S.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,de),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Re),n.pixelStorei(n.UNPACK_SKIP_ROWS,Fe)}}function Y(S,m,L){let X=n.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(X=n.TEXTURE_2D_ARRAY),m.isData3DTexture&&(X=n.TEXTURE_3D);const J=me(S,m),k=m.source;t.bindTexture(X,S.__webglTexture,n.TEXTURE0+L);const Ae=i.get(k);if(k.version!==Ae.__version||J===!0){t.activeTexture(n.TEXTURE0+L);const de=Ze.getPrimaries(Ze.workingColorSpace),Re=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Fe=m.colorSpace===pi||de===Re?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Fe);let fe=v(m.image,!1,r.maxTextureSize);fe=ne(m,fe);const Se=s.convert(m.format,m.colorSpace),Ee=s.convert(m.type);let Pe=A(m.internalFormat,Se,Ee,m.colorSpace,m.isVideoTexture);Ie(X,m);let ve;const Xe=m.mipmaps,N=m.isVideoTexture!==!0,Ce=Ae.__version===void 0||J===!0,_e=k.dataReady,Le=w(m,fe);if(m.isDepthTexture)Pe=y(m.format===Vi,m.type),Ce&&(N?t.texStorage2D(n.TEXTURE_2D,1,Pe,fe.width,fe.height):t.texImage2D(n.TEXTURE_2D,0,Pe,fe.width,fe.height,0,Se,Ee,null));else if(m.isDataTexture)if(Xe.length>0){N&&Ce&&t.texStorage2D(n.TEXTURE_2D,Le,Pe,Xe[0].width,Xe[0].height);for(let pe=0,oe=Xe.length;pe<oe;pe++)ve=Xe[pe],N?_e&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,ve.width,ve.height,Se,Ee,ve.data):t.texImage2D(n.TEXTURE_2D,pe,Pe,ve.width,ve.height,0,Se,Ee,ve.data);m.generateMipmaps=!1}else N?(Ce&&t.texStorage2D(n.TEXTURE_2D,Le,Pe,fe.width,fe.height),_e&&xe(m,fe,Se,Ee)):t.texImage2D(n.TEXTURE_2D,0,Pe,fe.width,fe.height,0,Se,Ee,fe.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){N&&Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Le,Pe,Xe[0].width,Xe[0].height,fe.depth);for(let pe=0,oe=Xe.length;pe<oe;pe++)if(ve=Xe[pe],m.format!==dn)if(Se!==null)if(N){if(_e)if(m.layerUpdates.size>0){const Me=yu(ve.width,ve.height,m.format,m.type);for(const ke of m.layerUpdates){const ut=ve.data.subarray(ke*Me/ve.data.BYTES_PER_ELEMENT,(ke+1)*Me/ve.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,ke,ve.width,ve.height,1,Se,ut)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,ve.width,ve.height,fe.depth,Se,ve.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,pe,Pe,ve.width,ve.height,fe.depth,0,ve.data,0,0);else We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?_e&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,ve.width,ve.height,fe.depth,Se,Ee,ve.data):t.texImage3D(n.TEXTURE_2D_ARRAY,pe,Pe,ve.width,ve.height,fe.depth,0,Se,Ee,ve.data)}else{N&&Ce&&t.texStorage2D(n.TEXTURE_2D,Le,Pe,Xe[0].width,Xe[0].height);for(let pe=0,oe=Xe.length;pe<oe;pe++)ve=Xe[pe],m.format!==dn?Se!==null?N?_e&&t.compressedTexSubImage2D(n.TEXTURE_2D,pe,0,0,ve.width,ve.height,Se,ve.data):t.compressedTexImage2D(n.TEXTURE_2D,pe,Pe,ve.width,ve.height,0,ve.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?_e&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,ve.width,ve.height,Se,Ee,ve.data):t.texImage2D(n.TEXTURE_2D,pe,Pe,ve.width,ve.height,0,Se,Ee,ve.data)}else if(m.isDataArrayTexture)if(N){if(Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Le,Pe,fe.width,fe.height,fe.depth),_e)if(m.layerUpdates.size>0){const pe=yu(fe.width,fe.height,m.format,m.type);for(const oe of m.layerUpdates){const Me=fe.data.subarray(oe*pe/fe.data.BYTES_PER_ELEMENT,(oe+1)*pe/fe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,oe,fe.width,fe.height,1,Se,Ee,Me)}m.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,Se,Ee,fe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Pe,fe.width,fe.height,fe.depth,0,Se,Ee,fe.data);else if(m.isData3DTexture)N?(Ce&&t.texStorage3D(n.TEXTURE_3D,Le,Pe,fe.width,fe.height,fe.depth),_e&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,Se,Ee,fe.data)):t.texImage3D(n.TEXTURE_3D,0,Pe,fe.width,fe.height,fe.depth,0,Se,Ee,fe.data);else if(m.isFramebufferTexture){if(Ce)if(N)t.texStorage2D(n.TEXTURE_2D,Le,Pe,fe.width,fe.height);else{let pe=fe.width,oe=fe.height;for(let Me=0;Me<Le;Me++)t.texImage2D(n.TEXTURE_2D,Me,Pe,pe,oe,0,Se,Ee,null),pe>>=1,oe>>=1}}else if(Xe.length>0){if(N&&Ce){const pe=ae(Xe[0]);t.texStorage2D(n.TEXTURE_2D,Le,Pe,pe.width,pe.height)}for(let pe=0,oe=Xe.length;pe<oe;pe++)ve=Xe[pe],N?_e&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,Se,Ee,ve):t.texImage2D(n.TEXTURE_2D,pe,Pe,Se,Ee,ve);m.generateMipmaps=!1}else if(N){if(Ce){const pe=ae(fe);t.texStorage2D(n.TEXTURE_2D,Le,Pe,pe.width,pe.height)}_e&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Se,Ee,fe)}else t.texImage2D(n.TEXTURE_2D,0,Pe,Se,Ee,fe);g(m)&&d(X),Ae.__version=k.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function Q(S,m,L){if(m.image.length!==6)return;const X=me(S,m),J=m.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+L);const k=i.get(J);if(J.version!==k.__version||X===!0){t.activeTexture(n.TEXTURE0+L);const Ae=Ze.getPrimaries(Ze.workingColorSpace),de=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Re=m.colorSpace===pi||Ae===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);const Fe=m.isCompressedTexture||m.image[0].isCompressedTexture,fe=m.image[0]&&m.image[0].isDataTexture,Se=[];for(let oe=0;oe<6;oe++)!Fe&&!fe?Se[oe]=v(m.image[oe],!0,r.maxCubemapSize):Se[oe]=fe?m.image[oe].image:m.image[oe],Se[oe]=ne(m,Se[oe]);const Ee=Se[0],Pe=s.convert(m.format,m.colorSpace),ve=s.convert(m.type),Xe=A(m.internalFormat,Pe,ve,m.colorSpace),N=m.isVideoTexture!==!0,Ce=k.__version===void 0||X===!0,_e=J.dataReady;let Le=w(m,Ee);Ie(n.TEXTURE_CUBE_MAP,m);let pe;if(Fe){N&&Ce&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Le,Xe,Ee.width,Ee.height);for(let oe=0;oe<6;oe++){pe=Se[oe].mipmaps;for(let Me=0;Me<pe.length;Me++){const ke=pe[Me];m.format!==dn?Pe!==null?N?_e&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me,0,0,ke.width,ke.height,Pe,ke.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me,Xe,ke.width,ke.height,0,ke.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me,0,0,ke.width,ke.height,Pe,ve,ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me,Xe,ke.width,ke.height,0,Pe,ve,ke.data)}}}else{if(pe=m.mipmaps,N&&Ce){pe.length>0&&Le++;const oe=ae(Se[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Le,Xe,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(fe){N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Se[oe].width,Se[oe].height,Pe,ve,Se[oe].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Xe,Se[oe].width,Se[oe].height,0,Pe,ve,Se[oe].data);for(let Me=0;Me<pe.length;Me++){const ut=pe[Me].image[oe].image;N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me+1,0,0,ut.width,ut.height,Pe,ve,ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me+1,Xe,ut.width,ut.height,0,Pe,ve,ut.data)}}else{N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Pe,ve,Se[oe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Xe,Pe,ve,Se[oe]);for(let Me=0;Me<pe.length;Me++){const ke=pe[Me];N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me+1,0,0,Pe,ve,ke.image[oe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Me+1,Xe,Pe,ve,ke.image[oe])}}}g(m)&&d(n.TEXTURE_CUBE_MAP),k.__version=J.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function ge(S,m,L,X,J,k){const Ae=s.convert(L.format,L.colorSpace),de=s.convert(L.type),Re=A(L.internalFormat,Ae,de,L.colorSpace),Fe=i.get(m),fe=i.get(L);if(fe.__renderTarget=m,!Fe.__hasExternalTextures){const Se=Math.max(1,m.width>>k),Ee=Math.max(1,m.height>>k);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?t.texImage3D(J,k,Re,Se,Ee,m.depth,0,Ae,de,null):t.texImage2D(J,k,Re,Se,Ee,0,Ae,de,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,X,J,fe.__webglTexture,0,T(m)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,X,J,fe.__webglTexture,k),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Be(S,m,L){if(n.bindRenderbuffer(n.RENDERBUFFER,S),m.depthBuffer){const X=m.depthTexture,J=X&&X.isDepthTexture?X.type:null,k=y(m.stencilBuffer,J),Ae=m.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;ue(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,T(m),k,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,T(m),k,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,k,m.width,m.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Ae,n.RENDERBUFFER,S)}else{const X=m.textures;for(let J=0;J<X.length;J++){const k=X[J],Ae=s.convert(k.format,k.colorSpace),de=s.convert(k.type),Re=A(k.internalFormat,Ae,de,k.colorSpace);ue(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,T(m),Re,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,T(m),Re,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,Re,m.width,m.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function be(S,m,L){const X=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const J=i.get(m.depthTexture);if(J.__renderTarget=m,(!J.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),X){if(J.__webglInit===void 0&&(J.__webglInit=!0,m.depthTexture.addEventListener("dispose",D)),J.__webglTexture===void 0){J.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),Ie(n.TEXTURE_CUBE_MAP,m.depthTexture);const Fe=s.convert(m.depthTexture.format),fe=s.convert(m.depthTexture.type);let Se;m.depthTexture.format===ei?Se=n.DEPTH_COMPONENT24:m.depthTexture.format===Vi&&(Se=n.DEPTH24_STENCIL8);for(let Ee=0;Ee<6;Ee++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Ee,0,Se,m.width,m.height,0,Fe,fe,null)}}else q(m.depthTexture,0);const k=J.__webglTexture,Ae=T(m),de=X?n.TEXTURE_CUBE_MAP_POSITIVE_X+L:n.TEXTURE_2D,Re=m.depthTexture.format===Vi?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(m.depthTexture.format===ei)ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Re,de,k,0,Ae):n.framebufferTexture2D(n.FRAMEBUFFER,Re,de,k,0);else if(m.depthTexture.format===Vi)ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Re,de,k,0,Ae):n.framebufferTexture2D(n.FRAMEBUFFER,Re,de,k,0);else throw new Error("Unknown depthTexture format")}function De(S){const m=i.get(S),L=S.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==S.depthTexture){const X=S.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),X){const J=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,X.removeEventListener("dispose",J)};X.addEventListener("dispose",J),m.__depthDisposeCallback=J}m.__boundDepthTexture=X}if(S.depthTexture&&!m.__autoAllocateDepthBuffer)if(L)for(let X=0;X<6;X++)be(m.__webglFramebuffer[X],S,X);else{const X=S.texture.mipmaps;X&&X.length>0?be(m.__webglFramebuffer[0],S,0):be(m.__webglFramebuffer,S,0)}else if(L){m.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[X]),m.__webglDepthbuffer[X]===void 0)m.__webglDepthbuffer[X]=n.createRenderbuffer(),Be(m.__webglDepthbuffer[X],S,!1);else{const J=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer[X];n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,k)}}else{const X=S.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=n.createRenderbuffer(),Be(m.__webglDepthbuffer,S,!1);else{const J=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,k)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function C(S,m,L){const X=i.get(S);m!==void 0&&ge(X.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),L!==void 0&&De(S)}function P(S){const m=S.texture,L=i.get(S),X=i.get(m);S.addEventListener("dispose",R);const J=S.textures,k=S.isWebGLCubeRenderTarget===!0,Ae=J.length>1;if(Ae||(X.__webglTexture===void 0&&(X.__webglTexture=n.createTexture()),X.__version=m.version,a.memory.textures++),k){L.__webglFramebuffer=[];for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer[de]=[];for(let Re=0;Re<m.mipmaps.length;Re++)L.__webglFramebuffer[de][Re]=n.createFramebuffer()}else L.__webglFramebuffer[de]=n.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer=[];for(let de=0;de<m.mipmaps.length;de++)L.__webglFramebuffer[de]=n.createFramebuffer()}else L.__webglFramebuffer=n.createFramebuffer();if(Ae)for(let de=0,Re=J.length;de<Re;de++){const Fe=i.get(J[de]);Fe.__webglTexture===void 0&&(Fe.__webglTexture=n.createTexture(),a.memory.textures++)}if(S.samples>0&&ue(S)===!1){L.__webglMultisampledFramebuffer=n.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let de=0;de<J.length;de++){const Re=J[de];L.__webglColorRenderbuffer[de]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,L.__webglColorRenderbuffer[de]);const Fe=s.convert(Re.format,Re.colorSpace),fe=s.convert(Re.type),Se=A(Re.internalFormat,Fe,fe,Re.colorSpace,S.isXRRenderTarget===!0),Ee=T(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ee,Se,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,L.__webglColorRenderbuffer[de])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(L.__webglDepthRenderbuffer=n.createRenderbuffer(),Be(L.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(k){t.bindTexture(n.TEXTURE_CUBE_MAP,X.__webglTexture),Ie(n.TEXTURE_CUBE_MAP,m);for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0)for(let Re=0;Re<m.mipmaps.length;Re++)ge(L.__webglFramebuffer[de][Re],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Re);else ge(L.__webglFramebuffer[de],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);g(m)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ae){for(let de=0,Re=J.length;de<Re;de++){const Fe=J[de],fe=i.get(Fe);let Se=n.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(Se=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Se,fe.__webglTexture),Ie(Se,Fe),ge(L.__webglFramebuffer,S,Fe,n.COLOR_ATTACHMENT0+de,Se,0),g(Fe)&&d(Se)}t.unbindTexture()}else{let de=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(de=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(de,X.__webglTexture),Ie(de,m),m.mipmaps&&m.mipmaps.length>0)for(let Re=0;Re<m.mipmaps.length;Re++)ge(L.__webglFramebuffer[Re],S,m,n.COLOR_ATTACHMENT0,de,Re);else ge(L.__webglFramebuffer,S,m,n.COLOR_ATTACHMENT0,de,0);g(m)&&d(de),t.unbindTexture()}S.depthBuffer&&De(S)}function H(S){const m=S.textures;for(let L=0,X=m.length;L<X;L++){const J=m[L];if(g(J)){const k=b(S),Ae=i.get(J).__webglTexture;t.bindTexture(k,Ae),d(k),t.unbindTexture()}}}const te=[],Z=[];function re(S){if(S.samples>0){if(ue(S)===!1){const m=S.textures,L=S.width,X=S.height;let J=n.COLOR_BUFFER_BIT;const k=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Ae=i.get(S),de=m.length>1;if(de)for(let Fe=0;Fe<m.length;Fe++)t.bindFramebuffer(n.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer);const Re=S.texture.mipmaps;Re&&Re.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ae.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ae.__webglFramebuffer);for(let Fe=0;Fe<m.length;Fe++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),de){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Ae.__webglColorRenderbuffer[Fe]);const fe=i.get(m[Fe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,fe,0)}n.blitFramebuffer(0,0,L,X,0,0,L,X,J,n.NEAREST),l===!0&&(te.length=0,Z.length=0,te.push(n.COLOR_ATTACHMENT0+Fe),S.depthBuffer&&S.resolveDepthBuffer===!1&&(te.push(k),Z.push(k),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Z)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,te))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),de)for(let Fe=0;Fe<m.length;Fe++){t.bindFramebuffer(n.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,Ae.__webglColorRenderbuffer[Fe]);const fe=i.get(m[Fe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,fe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const m=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[m])}}}function T(S){return Math.min(r.maxSamples,S.samples)}function ue(S){const m=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function se(S){const m=a.render.frame;c.get(S)!==m&&(c.set(S,m),S.update())}function ne(S,m){const L=S.colorSpace,X=S.format,J=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||L!==Er&&L!==pi&&(Ze.getTransfer(L)===st?(X!==dn||J!==an)&&We("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qe("WebGLTextures: Unsupported texture color space:",L)),m}function ae(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(u.width=S.naturalWidth||S.width,u.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(u.width=S.displayWidth,u.height=S.displayHeight):(u.width=S.width,u.height=S.height),u}this.allocateTextureUnit=B,this.resetTextureUnits=U,this.setTexture2D=q,this.setTexture2DArray=W,this.setTexture3D=z,this.setTextureCube=ee,this.rebindTextures=C,this.setupRenderTarget=P,this.updateRenderTargetMipmap=H,this.updateMultisampleRenderTarget=re,this.setupDepthRenderbuffer=De,this.setupFrameBufferTexture=ge,this.useMultisampledRTT=ue,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function US(n,e){function t(i,r=pi){let s;const a=Ze.getTransfer(r);if(i===an)return n.UNSIGNED_BYTE;if(i===ec)return n.UNSIGNED_SHORT_4_4_4_4;if(i===tc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===vh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Sh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===_h)return n.BYTE;if(i===xh)return n.SHORT;if(i===rs)return n.UNSIGNED_SHORT;if(i===Ql)return n.INT;if(i===Dn)return n.UNSIGNED_INT;if(i===Tn)return n.FLOAT;if(i===Qn)return n.HALF_FLOAT;if(i===Mh)return n.ALPHA;if(i===Eh)return n.RGB;if(i===dn)return n.RGBA;if(i===ei)return n.DEPTH_COMPONENT;if(i===Vi)return n.DEPTH_STENCIL;if(i===yh)return n.RED;if(i===nc)return n.RED_INTEGER;if(i===Mr)return n.RG;if(i===ic)return n.RG_INTEGER;if(i===rc)return n.RGBA_INTEGER;if(i===Ks||i===js||i===Zs||i===Js)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ks)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ks)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jo||i===Zo||i===Jo||i===Qo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===jo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Zo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Jo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Qo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===el||i===tl||i===nl||i===il||i===rl||i===sl||i===al)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===el||i===tl)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===nl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===il)return s.COMPRESSED_R11_EAC;if(i===rl)return s.COMPRESSED_SIGNED_R11_EAC;if(i===sl)return s.COMPRESSED_RG11_EAC;if(i===al)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===ol||i===ll||i===cl||i===ul||i===fl||i===hl||i===dl||i===pl||i===ml||i===gl||i===_l||i===xl||i===vl||i===Sl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ol)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ll)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===cl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ul)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===fl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===hl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===dl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===pl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ml)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===gl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===_l)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===xl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===vl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Sl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ml||i===El||i===yl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Ml)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===El)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===yl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===bl||i===Tl||i===Al||i===wl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===bl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Tl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Al)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===wl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ss?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const NS=`
void main() {
...
}`;class OS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Bh(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Ln({vertexShader:NS,fragmentShader:FS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ni(new ba(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class BS extends br{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,u=null,c=null,f=null,h=null,p=null,_=null;const v=typeof XRWebGLBinding<"u",g=new OS,d={},b=t.getContextAttributes();let A=null,y=null;const w=[],D=[],R=new ot;let O=null;const x=new sn;x.viewport=new _t;const E=new sn;E.viewport=new _t;const I=[x,E],U=new $g;let B=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let Q=w[Y];return Q===void 0&&(Q=new po,w[Y]=Q),Q.getTargetRaySpace()},this.getControllerGrip=function(Y){let Q=w[Y];return Q===void 0&&(Q=new po,w[Y]=Q),Q.getGripSpace()},this.getHand=function(Y){let Q=w[Y];return Q===void 0&&(Q=new po,w[Y]=Q),Q.getHandSpace()};function q(Y){const Q=D.indexOf(Y.inputSource);if(Q===-1)return;const ge=w[Q];ge!==void 0&&(ge.update(Y.inputSource,Y.frame,u||a),ge.dispatchEvent({type:Y.type,data:Y.inputSource}))}function W(){r.removeEventListener("select",q),r.removeEventListener("selectstart",q),r.removeEventListener("selectend",q),r.removeEventListener("squeeze",q),r.removeEventListener("squeezestart",q),r.removeEventListener("squeezeend",q),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",z);for(let Y=0;Y<w.length;Y++){const Q=D[Y];Q!==null&&(D[Y]=null,w[Y].disconnect(Q))}B=null,V=null,g.reset();for(const Y in d)delete d[Y];e.setRenderTarget(A),p=null,h=null,f=null,r=null,y=null,xe.stop(),i.isPresenting=!1,e.setPixelRatio(O),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,i.isPresenting===!0&&We("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,i.isPresenting===!0&&We("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||a},this.setReferenceSpace=function(Y){u=Y},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f===null&&v&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(A=e.getRenderTarget(),r.addEventListener("select",q),r.addEventListener("selectstart",q),r.addEventListener("selectend",q),r.addEventListener("squeeze",q),r.addEventListener("squeezestart",q),r.addEventListener("squeezeend",q),r.addEventListener("end",W),r.addEventListener("inputsourceschange",z),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(R),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let ge=null,Be=null,be=null;b.depth&&(be=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ge=b.stencil?Vi:ei,Be=b.stencil?ss:Dn);const De={colorFormat:t.RGBA8,depthFormat:be,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(De),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),y=new Pn(h.textureWidth,h.textureHeight,{format:dn,type:an,depthTexture:new ls(h.textureWidth,h.textureHeight,Be,void 0,void 0,void 0,void 0,void 0,void 0,ge),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const ge={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,ge),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new Pn(p.framebufferWidth,p.framebufferHeight,{format:dn,type:an,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),u=null,a=await r.requestReferenceSpace(o),xe.setContext(r),xe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function z(Y){for(let Q=0;Q<Y.removed.length;Q++){const ge=Y.removed[Q],Be=D.indexOf(ge);Be>=0&&(D[Be]=null,w[Be].disconnect(ge))}for(let Q=0;Q<Y.added.length;Q++){const ge=Y.added[Q];let Be=D.indexOf(ge);if(Be===-1){for(let De=0;De<w.length;De++)if(De>=D.length){D.push(ge),Be=De;break}else if(D[De]===null){D[De]=ge,Be=De;break}if(Be===-1)break}const be=w[Be];be&&be.connect(ge)}}const ee=new $,ce=new $;function ie(Y,Q,ge){ee.setFromMatrixPosition(Q.matrixWorld),ce.setFromMatrixPosition(ge.matrixWorld);const Be=ee.distanceTo(ce),be=Q.projectionMatrix.elements,De=ge.projectionMatrix.elements,C=be[14]/(be[10]-1),P=be[14]/(be[10]+1),H=(be[9]+1)/be[5],te=(be[9]-1)/be[5],Z=(be[8]-1)/be[0],re=(De[8]+1)/De[0],T=C*Z,ue=C*re,se=Be/(-Z+re),ne=se*-Z;if(Q.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(ne),Y.translateZ(se),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),be[10]===-1)Y.projectionMatrix.copy(Q.projectionMatrix),Y.projectionMatrixInverse.copy(Q.projectionMatrixInverse);else{const ae=C+se,S=P+se,m=T-ne,L=ue+(Be-ne),X=H*P/S*ae,J=te*P/S*ae;Y.projectionMatrix.makePerspective(m,L,X,J,ae,S),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function le(Y,Q){Q===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(Q.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let Q=Y.near,ge=Y.far;g.texture!==null&&(g.depthNear>0&&(Q=g.depthNear),g.depthFar>0&&(ge=g.depthFar)),U.near=E.near=x.near=Q,U.far=E.far=x.far=ge,(B!==U.near||V!==U.far)&&(r.updateRenderState({depthNear:U.near,depthFar:U.far}),B=U.near,V=U.far),U.layers.mask=Y.layers.mask|6,x.layers.mask=U.layers.mask&3,E.layers.mask=U.layers.mask&5;const Be=Y.parent,be=U.cameras;le(U,Be);for(let De=0;De<be.length;De++)le(be[De],Be);be.length===2?ie(U,x,E):U.projectionMatrix.copy(x.projectionMatrix),Ie(Y,U,Be)};function Ie(Y,Q,ge){ge===null?Y.matrix.copy(Q.matrixWorld):(Y.matrix.copy(ge.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(Q.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(Q.projectionMatrix),Y.projectionMatrixInverse.copy(Q.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Cl*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return U},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(Y){l=Y,h!==null&&(h.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(U)},this.getCameraTexture=function(Y){return d[Y]};let me=null;function he(Y,Q){if(c=Q.getViewerPose(u||a),_=Q,c!==null){const ge=c.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let Be=!1;ge.length!==U.cameras.length&&(U.cameras.length=0,Be=!0);for(let P=0;P<ge.length;P++){const H=ge[P];let te=null;if(p!==null)te=p.getViewport(H);else{const re=f.getViewSubImage(h,H);te=re.viewport,P===0&&(e.setRenderTargetTextures(y,re.colorTexture,re.depthStencilTexture),e.setRenderTarget(y))}let Z=I[P];Z===void 0&&(Z=new sn,Z.layers.enable(P),Z.viewport=new _t,I[P]=Z),Z.matrix.fromArray(H.transform.matrix),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.projectionMatrix.fromArray(H.projectionMatrix),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert(),Z.viewport.set(te.x,te.y,te.width,te.height),P===0&&(U.matrix.copy(Z.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale)),Be===!0&&U.cameras.push(Z)}const be=r.enabledFeatures;if(be&&be.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){f=i.getBinding();const P=f.getDepthInformation(ge[0]);P&&P.isValid&&P.texture&&g.init(P,r.renderState)}if(be&&be.includes("camera-access")&&v){e.state.unbindTexture(),f=i.getBinding();for(let P=0;P<ge.length;P++){const H=ge[P].camera;if(H){let te=d[H];te||(te=new Bh,d[H]=te);const Z=f.getCameraImage(H);te.sourceTexture=Z}}}}for(let ge=0;ge<w.length;ge++){const Be=D[ge],be=w[ge];Be!==null&&be!==void 0&&be.update(Be,Q,u||a)}me&&me(Y,Q),Q.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Q}),_=null}const xe=new Vh;xe.setAnimationLoop(he),this.setAnimationLoop=function(Y){me=Y},this.dispose=function(){}}}const Ii=new ti,zS=new xt;function VS(n,e){function t(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function i(g,d){d.color.getRGB(g.fogColor.value,Lh(n)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function r(g,d,b,A,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(g,d):d.isMeshToonMaterial?(s(g,d),f(g,d)):d.isMeshPhongMaterial?(s(g,d),c(g,d)):d.isMeshStandardMaterial?(s(g,d),h(g,d),d.isMeshPhysicalMaterial&&p(g,d,y)):d.isMeshMatcapMaterial?(s(g,d),_(g,d)):d.isMeshDepthMaterial?s(g,d):d.isMeshDistanceMaterial?(s(g,d),v(g,d)):d.isMeshNormalMaterial?s(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?l(g,d,b,A):d.isSpriteMaterial?u(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,t(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===Wt&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,t(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===Wt&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,t(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,t(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);const b=e.get(d),A=b.envMap,y=b.envMapRotation;A&&(g.envMap.value=A,Ii.copy(y),Ii.x*=-1,Ii.y*=-1,Ii.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(Ii.y*=-1,Ii.z*=-1),g.envMapRotation.value.setFromMatrix4(zS.makeRotationFromEuler(Ii)),g.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function l(g,d,b,A){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*b,g.scale.value=A*.5,d.map&&(g.map.value=d.map,t(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function u(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function c(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function f(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function h(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function p(g,d,b){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Wt&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=b.texture,g.transmissionSamplerSize.value.set(b.width,b.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,d){d.matcap&&(g.matcap.value=d.matcap)}function v(g,d){const b=e.get(d).light;g.referencePosition.value.setFromMatrixPosition(b.matrixWorld),g.nearDistance.value=b.shadow.camera.near,g.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function HS(n,e,t,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,A){const y=A.program;i.uniformBlockBinding(b,y)}function u(b,A){let y=r[b.id];y===void 0&&(_(b),y=c(b),r[b.id]=y,b.addEventListener("dispose",g));const w=A.program;i.updateUBOMapping(b,w);const D=e.render.frame;s[b.id]!==D&&(h(b),s[b.id]=D)}function c(b){const A=f();b.__bindingPointIndex=A;const y=n.createBuffer(),w=b.__size,D=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,w,D),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,A,y),y}function f(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return Qe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(b){const A=r[b.id],y=b.uniforms,w=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,A);for(let D=0,R=y.length;D<R;D++){const O=Array.isArray(y[D])?y[D]:[y[D]];for(let x=0,E=O.length;x<E;x++){const I=O[x];if(p(I,D,x,w)===!0){const U=I.__offset,B=Array.isArray(I.value)?I.value:[I.value];let V=0;for(let q=0;q<B.length;q++){const W=B[q],z=v(W);typeof W=="number"||typeof W=="boolean"?(I.__data[0]=W,n.bufferSubData(n.UNIFORM_BUFFER,U+V,I.__data)):W.isMatrix3?(I.__data[0]=W.elements[0],I.__data[1]=W.elements[1],I.__data[2]=W.elements[2],I.__data[3]=0,I.__data[4]=W.elements[3],I.__data[5]=W.elements[4],I.__data[6]=W.elements[5],I.__data[7]=0,I.__data[8]=W.elements[6],I.__data[9]=W.elements[7],I.__data[10]=W.elements[8],I.__data[11]=0):(W.toArray(I.__data,V),V+=z.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,U,I.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(b,A,y,w){const D=b.value,R=A+"_"+y;if(w[R]===void 0)return typeof D=="number"||typeof D=="boolean"?w[R]=D:w[R]=D.clone(),!0;{const O=w[R];if(typeof D=="number"||typeof D=="boolean"){if(O!==D)return w[R]=D,!0}else if(O.equals(D)===!1)return O.copy(D),!0}return!1}function _(b){const A=b.uniforms;let y=0;const w=16;for(let R=0,O=A.length;R<O;R++){const x=Array.isArray(A[R])?A[R]:[A[R]];for(let E=0,I=x.length;E<I;E++){const U=x[E],B=Array.isArray(U.value)?U.value:[U.value];for(let V=0,q=B.length;V<q;V++){const W=B[V],z=v(W),ee=y%w,ce=ee%z.boundary,ie=ee+ce;y+=ce,ie!==0&&w-ie<z.storage&&(y+=w-ie),U.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=y,y+=z.storage}}}const D=y%w;return D>0&&(y+=w-D),b.__size=y,b.__cache={},this}function v(b){const A={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(A.boundary=4,A.storage=4):b.isVector2?(A.boundary=8,A.storage=8):b.isVector3||b.isColor?(A.boundary=16,A.storage=12):b.isVector4?(A.boundary=16,A.storage=16):b.isMatrix3?(A.boundary=48,A.storage=48):b.isMatrix4?(A.boundary=64,A.storage=64):b.isTexture?We("WebGLRenderer: Texture samplers can not be part of an uniforms group."):We("WebGLRenderer: Unsupported uniform value type.",b),A}function g(b){const A=b.target;A.removeEventListener("dispose",g);const y=a.indexOf(A.__bindingPointIndex);a.splice(y,1),n.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function d(){for(const b in r)n.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:u,dispose:d}}const GS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Mn=null;function kS(){return Mn===null&&(Mn=new Ng(GS,16,16,Mr,Qn),Mn.name="DFG_LUT",Mn.minFilter=Dt,Mn.magFilter=Dt,Mn.wrapS=qn,Mn.wrapT=qn,Mn.generateMipmaps=!1,Mn.needsUpdate=!0),Mn}class WS{constructor(e={}){const{canvas:t=lg(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:c="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:p=an}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=a;const v=p,g=new Set([rc,ic,nc]),d=new Set([an,Dn,rs,ss,ec,tc]),b=new Uint32Array(4),A=new Int32Array(4);let y=null,w=null;const D=[],R=[];let O=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let E=!1;this._outputColorSpace=nn;let I=0,U=0,B=null,V=-1,q=null;const W=new _t,z=new _t;let ee=null;const ce=new nt(0);let ie=0,le=t.width,Ie=t.height,me=1,he=null,xe=null;const Y=new _t(0,0,le,Ie),Q=new _t(0,0,le,Ie);let ge=!1;const Be=new Fh;let be=!1,De=!1;const C=new xt,P=new $,H=new _t,te={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Z=!1;function re(){return B===null?me:1}let T=i;function ue(M,F){return t.getContext(M,F)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:c,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Jl}`),t.addEventListener("webglcontextlost",ke,!1),t.addEventListener("webglcontextrestored",ut,!1),t.addEventListener("webglcontextcreationerror",it,!1),T===null){const F="webgl2";if(T=ue(F,M),T===null)throw ue(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw Qe("WebGLRenderer: "+M.message),M}let se,ne,ae,S,m,L,X,J,k,Ae,de,Re,Fe,fe,Se,Ee,Pe,ve,Xe,N,Ce,_e,Le,pe;function oe(){se=new kx(T),se.init(),_e=new US(T,se),ne=new Ux(T,se,e,_e),ae=new LS(T,se),ne.reversedDepthBuffer&&h&&ae.buffers.depth.setReversed(!0),S=new qx(T),m=new _S,L=new IS(T,se,ae,m,ne,_e,S),X=new Fx(x),J=new Gx(x),k=new jg(T),Le=new Lx(T,k),Ae=new Wx(T,k,S,Le),de=new $x(T,Ae,k,S),Xe=new Yx(T,ne,L),Ee=new Nx(m),Re=new gS(x,X,J,se,ne,Le,Ee),Fe=new VS(x,m),fe=new vS,Se=new TS(se),ve=new Dx(x,X,J,ae,de,_,l),Pe=new PS(x,de,ne),pe=new HS(T,S,ne,ae),N=new Ix(T,se,S),Ce=new Xx(T,se,S),S.programs=Re.programs,x.capabilities=ne,x.extensions=se,x.properties=m,x.renderLists=fe,x.shadowMap=Pe,x.state=ae,x.info=S}oe(),v!==an&&(O=new jx(v,t.width,t.height,r,s));const Me=new BS(x,T);this.xr=Me,this.getContext=function(){return T},this.getContextAttributes=function(){return T.getContextAttributes()},this.forceContextLoss=function(){const M=se.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=se.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return me},this.setPixelRatio=function(M){M!==void 0&&(me=M,this.setSize(le,Ie,!1))},this.getSize=function(M){return M.set(le,Ie)},this.setSize=function(M,F,j=!0){if(Me.isPresenting){We("WebGLRenderer: Can't change size while VR device is presenting.");return}le=M,Ie=F,t.width=Math.floor(M*me),t.height=Math.floor(F*me),j===!0&&(t.style.width=M+"px",t.style.height=F+"px"),O!==null&&O.setSize(t.width,t.height),this.setViewport(0,0,M,F)},this.getDrawingBufferSize=function(M){return M.set(le*me,Ie*me).floor()},this.setDrawingBufferSize=function(M,F,j){le=M,Ie=F,me=j,t.width=Math.floor(M*j),t.height=Math.floor(F*j),this.setViewport(0,0,M,F)},this.setEffects=function(M){if(v===an){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let F=0;F<M.length;F++)if(M[F].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}O.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(W)},this.getViewport=function(M){return M.copy(Y)},this.setViewport=function(M,F,j,K){M.isVector4?Y.set(M.x,M.y,M.z,M.w):Y.set(M,F,j,K),ae.viewport(W.copy(Y).multiplyScalar(me).round())},this.getScissor=function(M){return M.copy(Q)},this.setScissor=function(M,F,j,K){M.isVector4?Q.set(M.x,M.y,M.z,M.w):Q.set(M,F,j,K),ae.scissor(z.copy(Q).multiplyScalar(me).round())},this.getScissorTest=function(){return ge},this.setScissorTest=function(M){ae.setScissorTest(ge=M)},this.setOpaqueSort=function(M){he=M},this.setTransparentSort=function(M){xe=M},this.getClearColor=function(M){return M.copy(ve.getClearColor())},this.setClearColor=function(){ve.setClearColor(...arguments)},this.getClearAlpha=function(){return ve.getClearAlpha()},this.setClearAlpha=function(){ve.setClearAlpha(...arguments)},this.clear=function(M=!0,F=!0,j=!0){let K=0;if(M){let G=!1;if(B!==null){const ye=B.texture.format;G=g.has(ye)}if(G){const ye=B.texture.type,Ue=d.has(ye),we=ve.getClearColor(),Ne=ve.getClearAlpha(),Oe=we.r,He=we.g,ze=we.b;Ue?(b[0]=Oe,b[1]=He,b[2]=ze,b[3]=Ne,T.clearBufferuiv(T.COLOR,0,b)):(A[0]=Oe,A[1]=He,A[2]=ze,A[3]=Ne,T.clearBufferiv(T.COLOR,0,A))}else K|=T.COLOR_BUFFER_BIT}F&&(K|=T.DEPTH_BUFFER_BIT),j&&(K|=T.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),T.clear(K)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ke,!1),t.removeEventListener("webglcontextrestored",ut,!1),t.removeEventListener("webglcontextcreationerror",it,!1),ve.dispose(),fe.dispose(),Se.dispose(),m.dispose(),X.dispose(),J.dispose(),de.dispose(),Le.dispose(),pe.dispose(),Re.dispose(),Me.dispose(),Me.removeEventListener("sessionstart",fc),Me.removeEventListener("sessionend",hc),Ei.stop()};function ke(M){M.preventDefault(),ru("WebGLRenderer: Context Lost."),E=!0}function ut(){ru("WebGLRenderer: Context Restored."),E=!1;const M=S.autoReset,F=Pe.enabled,j=Pe.autoUpdate,K=Pe.needsUpdate,G=Pe.type;oe(),S.autoReset=M,Pe.enabled=F,Pe.autoUpdate=j,Pe.needsUpdate=K,Pe.type=G}function it(M){Qe("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function vn(M){const F=M.target;F.removeEventListener("dispose",vn),In(F)}function In(M){Xh(M),m.remove(M)}function Xh(M){const F=m.get(M).programs;F!==void 0&&(F.forEach(function(j){Re.releaseProgram(j)}),M.isShaderMaterial&&Re.releaseShaderCache(M))}this.renderBufferDirect=function(M,F,j,K,G,ye){F===null&&(F=te);const Ue=G.isMesh&&G.matrixWorld.determinant()<0,we=Yh(M,F,j,K,G);ae.setMaterial(K,Ue);let Ne=j.index,Oe=1;if(K.wireframe===!0){if(Ne=Ae.getWireframeAttribute(j),Ne===void 0)return;Oe=2}const He=j.drawRange,ze=j.attributes.position;let Ke=He.start*Oe,at=(He.start+He.count)*Oe;ye!==null&&(Ke=Math.max(Ke,ye.start*Oe),at=Math.min(at,(ye.start+ye.count)*Oe)),Ne!==null?(Ke=Math.max(Ke,0),at=Math.min(at,Ne.count)):ze!=null&&(Ke=Math.max(Ke,0),at=Math.min(at,ze.count));const mt=at-Ke;if(mt<0||mt===1/0)return;Le.setup(G,K,we,j,Ne);let gt,lt=N;if(Ne!==null&&(gt=k.get(Ne),lt=Ce,lt.setIndex(gt)),G.isMesh)K.wireframe===!0?(ae.setLineWidth(K.wireframeLinewidth*re()),lt.setMode(T.LINES)):lt.setMode(T.TRIANGLES);else if(G.isLine){let Ve=K.linewidth;Ve===void 0&&(Ve=1),ae.setLineWidth(Ve*re()),G.isLineSegments?lt.setMode(T.LINES):G.isLineLoop?lt.setMode(T.LINE_LOOP):lt.setMode(T.LINE_STRIP)}else G.isPoints?lt.setMode(T.POINTS):G.isSprite&&lt.setMode(T.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)os("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),lt.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(se.get("WEBGL_multi_draw"))lt.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Ve=G._multiDrawStarts,rt=G._multiDrawCounts,Je=G._multiDrawCount,qt=Ne?k.get(Ne).bytesPerElement:1,Wi=m.get(K).currentProgram.getUniforms();for(let Yt=0;Yt<Je;Yt++)Wi.setValue(T,"_gl_DrawID",Yt),lt.render(Ve[Yt]/qt,rt[Yt])}else if(G.isInstancedMesh)lt.renderInstances(Ke,mt,G.count);else if(j.isInstancedBufferGeometry){const Ve=j._maxInstanceCount!==void 0?j._maxInstanceCount:1/0,rt=Math.min(j.instanceCount,Ve);lt.renderInstances(Ke,mt,rt)}else lt.render(Ke,mt)};function uc(M,F,j){M.transparent===!0&&M.side===Xn&&M.forceSinglePass===!1?(M.side=Wt,M.needsUpdate=!0,_s(M,F,j),M.side=Si,M.needsUpdate=!0,_s(M,F,j),M.side=Xn):_s(M,F,j)}this.compile=function(M,F,j=null){j===null&&(j=M),w=Se.get(j),w.init(F),R.push(w),j.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(w.pushLight(G),G.castShadow&&w.pushShadow(G))}),M!==j&&M.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(w.pushLight(G),G.castShadow&&w.pushShadow(G))}),w.setupLights();const K=new Set;return M.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const ye=G.material;if(ye)if(Array.isArray(ye))for(let Ue=0;Ue<ye.length;Ue++){const we=ye[Ue];uc(we,j,G),K.add(we)}else uc(ye,j,G),K.add(ye)}),w=R.pop(),K},this.compileAsync=function(M,F,j=null){const K=this.compile(M,F,j);return new Promise(G=>{function ye(){if(K.forEach(function(Ue){m.get(Ue).currentProgram.isReady()&&K.delete(Ue)}),K.size===0){G(M);return}setTimeout(ye,10)}se.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let Ca=null;function qh(M){Ca&&Ca(M)}function fc(){Ei.stop()}function hc(){Ei.start()}const Ei=new Vh;Ei.setAnimationLoop(qh),typeof self<"u"&&Ei.setContext(self),this.setAnimationLoop=function(M){Ca=M,Me.setAnimationLoop(M),M===null?Ei.stop():Ei.start()},Me.addEventListener("sessionstart",fc),Me.addEventListener("sessionend",hc),this.render=function(M,F){if(F!==void 0&&F.isCamera!==!0){Qe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;const j=Me.enabled===!0&&Me.isPresenting===!0,K=O!==null&&(B===null||j)&&O.begin(x,B);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),Me.enabled===!0&&Me.isPresenting===!0&&(O===null||O.isCompositing()===!1)&&(Me.cameraAutoUpdate===!0&&Me.updateCamera(F),F=Me.getCamera()),M.isScene===!0&&M.onBeforeRender(x,M,F,B),w=Se.get(M,R.length),w.init(F),R.push(w),C.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Be.setFromProjectionMatrix(C,An,F.reversedDepth),De=this.localClippingEnabled,be=Ee.init(this.clippingPlanes,De),y=fe.get(M,D.length),y.init(),D.push(y),Me.enabled===!0&&Me.isPresenting===!0){const Ue=x.xr.getDepthSensingMesh();Ue!==null&&Ra(Ue,F,-1/0,x.sortObjects)}Ra(M,F,0,x.sortObjects),y.finish(),x.sortObjects===!0&&y.sort(he,xe),Z=Me.enabled===!1||Me.isPresenting===!1||Me.hasDepthSensing()===!1,Z&&ve.addToRenderList(y,M),this.info.render.frame++,be===!0&&Ee.beginShadows();const G=w.state.shadowsArray;if(Pe.render(G,M,F),be===!0&&Ee.endShadows(),this.info.autoReset===!0&&this.info.reset(),(K&&O.hasRenderPass())===!1){const Ue=y.opaque,we=y.transmissive;if(w.setupLights(),F.isArrayCamera){const Ne=F.cameras;if(we.length>0)for(let Oe=0,He=Ne.length;Oe<He;Oe++){const ze=Ne[Oe];pc(Ue,we,M,ze)}Z&&ve.render(M);for(let Oe=0,He=Ne.length;Oe<He;Oe++){const ze=Ne[Oe];dc(y,M,ze,ze.viewport)}}else we.length>0&&pc(Ue,we,M,F),Z&&ve.render(M),dc(y,M,F)}B!==null&&U===0&&(L.updateMultisampleRenderTarget(B),L.updateRenderTargetMipmap(B)),K&&O.end(x),M.isScene===!0&&M.onAfterRender(x,M,F),Le.resetDefaultState(),V=-1,q=null,R.pop(),R.length>0?(w=R[R.length-1],be===!0&&Ee.setGlobalState(x.clippingPlanes,w.state.camera)):w=null,D.pop(),D.length>0?y=D[D.length-1]:y=null};function Ra(M,F,j,K){if(M.visible===!1)return;if(M.layers.test(F.layers)){if(M.isGroup)j=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(F);else if(M.isLight)w.pushLight(M),M.castShadow&&w.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Be.intersectsSprite(M)){K&&H.setFromMatrixPosition(M.matrixWorld).applyMatrix4(C);const Ue=de.update(M),we=M.material;we.visible&&y.push(M,Ue,we,j,H.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Be.intersectsObject(M))){const Ue=de.update(M),we=M.material;if(K&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),H.copy(M.boundingSphere.center)):(Ue.boundingSphere===null&&Ue.computeBoundingSphere(),H.copy(Ue.boundingSphere.center)),H.applyMatrix4(M.matrixWorld).applyMatrix4(C)),Array.isArray(we)){const Ne=Ue.groups;for(let Oe=0,He=Ne.length;Oe<He;Oe++){const ze=Ne[Oe],Ke=we[ze.materialIndex];Ke&&Ke.visible&&y.push(M,Ue,Ke,j,H.z,ze)}}else we.visible&&y.push(M,Ue,we,j,H.z,null)}}const ye=M.children;for(let Ue=0,we=ye.length;Ue<we;Ue++)Ra(ye[Ue],F,j,K)}function dc(M,F,j,K){const{opaque:G,transmissive:ye,transparent:Ue}=M;w.setupLightsView(j),be===!0&&Ee.setGlobalState(x.clippingPlanes,j),K&&ae.viewport(W.copy(K)),G.length>0&&gs(G,F,j),ye.length>0&&gs(ye,F,j),Ue.length>0&&gs(Ue,F,j),ae.buffers.depth.setTest(!0),ae.buffers.depth.setMask(!0),ae.buffers.color.setMask(!0),ae.setPolygonOffset(!1)}function pc(M,F,j,K){if((j.isScene===!0?j.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[K.id]===void 0){const Ke=se.has("EXT_color_buffer_half_float")||se.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[K.id]=new Pn(1,1,{generateMipmaps:!0,type:Ke?Qn:an,minFilter:zi,samples:ne.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ze.workingColorSpace})}const ye=w.state.transmissionRenderTarget[K.id],Ue=K.viewport||W;ye.setSize(Ue.z*x.transmissionResolutionScale,Ue.w*x.transmissionResolutionScale);const we=x.getRenderTarget(),Ne=x.getActiveCubeFace(),Oe=x.getActiveMipmapLevel();x.setRenderTarget(ye),x.getClearColor(ce),ie=x.getClearAlpha(),ie<1&&x.setClearColor(16777215,.5),x.clear(),Z&&ve.render(j);const He=x.toneMapping;x.toneMapping=Rn;const ze=K.viewport;if(K.viewport!==void 0&&(K.viewport=void 0),w.setupLightsView(K),be===!0&&Ee.setGlobalState(x.clippingPlanes,K),gs(M,j,K),L.updateMultisampleRenderTarget(ye),L.updateRenderTargetMipmap(ye),se.has("WEBGL_multisampled_render_to_texture")===!1){let Ke=!1;for(let at=0,mt=F.length;at<mt;at++){const gt=F[at],{object:lt,geometry:Ve,material:rt,group:Je}=gt;if(rt.side===Xn&&lt.layers.test(K.layers)){const qt=rt.side;rt.side=Wt,rt.needsUpdate=!0,mc(lt,j,K,Ve,rt,Je),rt.side=qt,rt.needsUpdate=!0,Ke=!0}}Ke===!0&&(L.updateMultisampleRenderTarget(ye),L.updateRenderTargetMipmap(ye))}x.setRenderTarget(we,Ne,Oe),x.setClearColor(ce,ie),ze!==void 0&&(K.viewport=ze),x.toneMapping=He}function gs(M,F,j){const K=F.isScene===!0?F.overrideMaterial:null;for(let G=0,ye=M.length;G<ye;G++){const Ue=M[G],{object:we,geometry:Ne,group:Oe}=Ue;let He=Ue.material;He.allowOverride===!0&&K!==null&&(He=K),we.layers.test(j.layers)&&mc(we,F,j,Ne,He,Oe)}}function mc(M,F,j,K,G,ye){M.onBeforeRender(x,F,j,K,G,ye),M.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),G.onBeforeRender(x,F,j,K,M,ye),G.transparent===!0&&G.side===Xn&&G.forceSinglePass===!1?(G.side=Wt,G.needsUpdate=!0,x.renderBufferDirect(j,F,K,G,M,ye),G.side=Si,G.needsUpdate=!0,x.renderBufferDirect(j,F,K,G,M,ye),G.side=Xn):x.renderBufferDirect(j,F,K,G,M,ye),M.onAfterRender(x,F,j,K,G,ye)}function _s(M,F,j){F.isScene!==!0&&(F=te);const K=m.get(M),G=w.state.lights,ye=w.state.shadowsArray,Ue=G.state.version,we=Re.getParameters(M,G.state,ye,F,j),Ne=Re.getProgramCacheKey(we);let Oe=K.programs;K.environment=M.isMeshStandardMaterial?F.environment:null,K.fog=F.fog,K.envMap=(M.isMeshStandardMaterial?J:X).get(M.envMap||K.environment),K.envMapRotation=K.environment!==null&&M.envMap===null?F.environmentRotation:M.envMapRotation,Oe===void 0&&(M.addEventListener("dispose",vn),Oe=new Map,K.programs=Oe);let He=Oe.get(Ne);if(He!==void 0){if(K.currentProgram===He&&K.lightsStateVersion===Ue)return _c(M,we),He}else we.uniforms=Re.getUniforms(M),M.onBeforeCompile(we,x),He=Re.acquireProgram(we,Ne),Oe.set(Ne,He),K.uniforms=we.uniforms;const ze=K.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(ze.clippingPlanes=Ee.uniform),_c(M,we),K.needsLights=Kh(M),K.lightsStateVersion=Ue,K.needsLights&&(ze.ambientLightColor.value=G.state.ambient,ze.lightProbe.value=G.state.probe,ze.directionalLights.value=G.state.directional,ze.directionalLightShadows.value=G.state.directionalShadow,ze.spotLights.value=G.state.spot,ze.spotLightShadows.value=G.state.spotShadow,ze.rectAreaLights.value=G.state.rectArea,ze.ltc_1.value=G.state.rectAreaLTC1,ze.ltc_2.value=G.state.rectAreaLTC2,ze.pointLights.value=G.state.point,ze.pointLightShadows.value=G.state.pointShadow,ze.hemisphereLights.value=G.state.hemi,ze.directionalShadowMap.value=G.state.directionalShadowMap,ze.directionalShadowMatrix.value=G.state.directionalShadowMatrix,ze.spotShadowMap.value=G.state.spotShadowMap,ze.spotLightMatrix.value=G.state.spotLightMatrix,ze.spotLightMap.value=G.state.spotLightMap,ze.pointShadowMap.value=G.state.pointShadowMap,ze.pointShadowMatrix.value=G.state.pointShadowMatrix),K.currentProgram=He,K.uniformsList=null,He}function gc(M){if(M.uniformsList===null){const F=M.currentProgram.getUniforms();M.uniformsList=Qs.seqWithValue(F.seq,M.uniforms)}return M.uniformsList}function _c(M,F){const j=m.get(M);j.outputColorSpace=F.outputColorSpace,j.batching=F.batching,j.batchingColor=F.batchingColor,j.instancing=F.instancing,j.instancingColor=F.instancingColor,j.instancingMorph=F.instancingMorph,j.skinning=F.skinning,j.morphTargets=F.morphTargets,j.morphNormals=F.morphNormals,j.morphColors=F.morphColors,j.morphTargetsCount=F.morphTargetsCount,j.numClippingPlanes=F.numClippingPlanes,j.numIntersection=F.numClipIntersection,j.vertexAlphas=F.vertexAlphas,j.vertexTangents=F.vertexTangents,j.toneMapping=F.toneMapping}function Yh(M,F,j,K,G){F.isScene!==!0&&(F=te),L.resetTextureUnits();const ye=F.fog,Ue=K.isMeshStandardMaterial?F.environment:null,we=B===null?x.outputColorSpace:B.isXRRenderTarget===!0?B.texture.colorSpace:Er,Ne=(K.isMeshStandardMaterial?J:X).get(K.envMap||Ue),Oe=K.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,He=!!j.attributes.tangent&&(!!K.normalMap||K.anisotropy>0),ze=!!j.morphAttributes.position,Ke=!!j.morphAttributes.normal,at=!!j.morphAttributes.color;let mt=Rn;K.toneMapped&&(B===null||B.isXRRenderTarget===!0)&&(mt=x.toneMapping);const gt=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,lt=gt!==void 0?gt.length:0,Ve=m.get(K),rt=w.state.lights;if(be===!0&&(De===!0||M!==q)){const Ut=M===q&&K.id===V;Ee.setState(K,M,Ut)}let Je=!1;K.version===Ve.__version?(Ve.needsLights&&Ve.lightsStateVersion!==rt.state.version||Ve.outputColorSpace!==we||G.isBatchedMesh&&Ve.batching===!1||!G.isBatchedMesh&&Ve.batching===!0||G.isBatchedMesh&&Ve.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Ve.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Ve.instancing===!1||!G.isInstancedMesh&&Ve.instancing===!0||G.isSkinnedMesh&&Ve.skinning===!1||!G.isSkinnedMesh&&Ve.skinning===!0||G.isInstancedMesh&&Ve.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Ve.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Ve.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Ve.instancingMorph===!1&&G.morphTexture!==null||Ve.envMap!==Ne||K.fog===!0&&Ve.fog!==ye||Ve.numClippingPlanes!==void 0&&(Ve.numClippingPlanes!==Ee.numPlanes||Ve.numIntersection!==Ee.numIntersection)||Ve.vertexAlphas!==Oe||Ve.vertexTangents!==He||Ve.morphTargets!==ze||Ve.morphNormals!==Ke||Ve.morphColors!==at||Ve.toneMapping!==mt||Ve.morphTargetsCount!==lt)&&(Je=!0):(Je=!0,Ve.__version=K.version);let qt=Ve.currentProgram;Je===!0&&(qt=_s(K,F,G));let Wi=!1,Yt=!1,Ar=!1;const ft=qt.getUniforms(),Vt=Ve.uniforms;if(ae.useProgram(qt.program)&&(Wi=!0,Yt=!0,Ar=!0),K.id!==V&&(V=K.id,Yt=!0),Wi||q!==M){ae.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),ft.setValue(T,"projectionMatrix",M.projectionMatrix),ft.setValue(T,"viewMatrix",M.matrixWorldInverse);const Ht=ft.map.cameraPosition;Ht!==void 0&&Ht.setValue(T,P.setFromMatrixPosition(M.matrixWorld)),ne.logarithmicDepthBuffer&&ft.setValue(T,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(K.isMeshPhongMaterial||K.isMeshToonMaterial||K.isMeshLambertMaterial||K.isMeshBasicMaterial||K.isMeshStandardMaterial||K.isShaderMaterial)&&ft.setValue(T,"isOrthographic",M.isOrthographicCamera===!0),q!==M&&(q=M,Yt=!0,Ar=!0)}if(Ve.needsLights&&(rt.state.directionalShadowMap.length>0&&ft.setValue(T,"directionalShadowMap",rt.state.directionalShadowMap,L),rt.state.spotShadowMap.length>0&&ft.setValue(T,"spotShadowMap",rt.state.spotShadowMap,L),rt.state.pointShadowMap.length>0&&ft.setValue(T,"pointShadowMap",rt.state.pointShadowMap,L)),G.isSkinnedMesh){ft.setOptional(T,G,"bindMatrix"),ft.setOptional(T,G,"bindMatrixInverse");const Ut=G.skeleton;Ut&&(Ut.boneTexture===null&&Ut.computeBoneTexture(),ft.setValue(T,"boneTexture",Ut.boneTexture,L))}G.isBatchedMesh&&(ft.setOptional(T,G,"batchingTexture"),ft.setValue(T,"batchingTexture",G._matricesTexture,L),ft.setOptional(T,G,"batchingIdTexture"),ft.setValue(T,"batchingIdTexture",G._indirectTexture,L),ft.setOptional(T,G,"batchingColorTexture"),G._colorsTexture!==null&&ft.setValue(T,"batchingColorTexture",G._colorsTexture,L));const Qt=j.morphAttributes;if((Qt.position!==void 0||Qt.normal!==void 0||Qt.color!==void 0)&&Xe.update(G,j,qt),(Yt||Ve.receiveShadow!==G.receiveShadow)&&(Ve.receiveShadow=G.receiveShadow,ft.setValue(T,"receiveShadow",G.receiveShadow)),K.isMeshGouraudMaterial&&K.envMap!==null&&(Vt.envMap.value=Ne,Vt.flipEnvMap.value=Ne.isCubeTexture&&Ne.isRenderTargetTexture===!1?-1:1),K.isMeshStandardMaterial&&K.envMap===null&&F.environment!==null&&(Vt.envMapIntensity.value=F.environmentIntensity),Vt.dfgLUT!==void 0&&(Vt.dfgLUT.value=kS()),Yt&&(ft.setValue(T,"toneMappingExposure",x.toneMappingExposure),Ve.needsLights&&$h(Vt,Ar),ye&&K.fog===!0&&Fe.refreshFogUniforms(Vt,ye),Fe.refreshMaterialUniforms(Vt,K,me,Ie,w.state.transmissionRenderTarget[M.id]),Qs.upload(T,gc(Ve),Vt,L)),K.isShaderMaterial&&K.uniformsNeedUpdate===!0&&(Qs.upload(T,gc(Ve),Vt,L),K.uniformsNeedUpdate=!1),K.isSpriteMaterial&&ft.setValue(T,"center",G.center),ft.setValue(T,"modelViewMatrix",G.modelViewMatrix),ft.setValue(T,"normalMatrix",G.normalMatrix),ft.setValue(T,"modelMatrix",G.matrixWorld),K.isShaderMaterial||K.isRawShaderMaterial){const Ut=K.uniformsGroups;for(let Ht=0,Pa=Ut.length;Ht<Pa;Ht++){const yi=Ut[Ht];pe.update(yi,qt),pe.bind(yi,qt)}}return qt}function $h(M,F){M.ambientLightColor.needsUpdate=F,M.lightProbe.needsUpdate=F,M.directionalLights.needsUpdate=F,M.directionalLightShadows.needsUpdate=F,M.pointLights.needsUpdate=F,M.pointLightShadows.needsUpdate=F,M.spotLights.needsUpdate=F,M.spotLightShadows.needsUpdate=F,M.rectAreaLights.needsUpdate=F,M.hemisphereLights.needsUpdate=F}function Kh(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return I},this.getActiveMipmapLevel=function(){return U},this.getRenderTarget=function(){return B},this.setRenderTargetTextures=function(M,F,j){const K=m.get(M);K.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,K.__autoAllocateDepthBuffer===!1&&(K.__useRenderToTexture=!1),m.get(M.texture).__webglTexture=F,m.get(M.depthTexture).__webglTexture=K.__autoAllocateDepthBuffer?void 0:j,K.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,F){const j=m.get(M);j.__webglFramebuffer=F,j.__useDefaultFramebuffer=F===void 0};const jh=T.createFramebuffer();this.setRenderTarget=function(M,F=0,j=0){B=M,I=F,U=j;let K=null,G=!1,ye=!1;if(M){const we=m.get(M);if(we.__useDefaultFramebuffer!==void 0){ae.bindFramebuffer(T.FRAMEBUFFER,we.__webglFramebuffer),W.copy(M.viewport),z.copy(M.scissor),ee=M.scissorTest,ae.viewport(W),ae.scissor(z),ae.setScissorTest(ee),V=-1;return}else if(we.__webglFramebuffer===void 0)L.setupRenderTarget(M);else if(we.__hasExternalTextures)L.rebindTextures(M,m.get(M.texture).__webglTexture,m.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const He=M.depthTexture;if(we.__boundDepthTexture!==He){if(He!==null&&m.has(He)&&(M.width!==He.image.width||M.height!==He.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(M)}}const Ne=M.texture;(Ne.isData3DTexture||Ne.isDataArrayTexture||Ne.isCompressedArrayTexture)&&(ye=!0);const Oe=m.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Oe[F])?K=Oe[F][j]:K=Oe[F],G=!0):M.samples>0&&L.useMultisampledRTT(M)===!1?K=m.get(M).__webglMultisampledFramebuffer:Array.isArray(Oe)?K=Oe[j]:K=Oe,W.copy(M.viewport),z.copy(M.scissor),ee=M.scissorTest}else W.copy(Y).multiplyScalar(me).floor(),z.copy(Q).multiplyScalar(me).floor(),ee=ge;if(j!==0&&(K=jh),ae.bindFramebuffer(T.FRAMEBUFFER,K)&&ae.drawBuffers(M,K),ae.viewport(W),ae.scissor(z),ae.setScissorTest(ee),G){const we=m.get(M.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_CUBE_MAP_POSITIVE_X+F,we.__webglTexture,j)}else if(ye){const we=F;for(let Ne=0;Ne<M.textures.length;Ne++){const Oe=m.get(M.textures[Ne]);T.framebufferTextureLayer(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0+Ne,Oe.__webglTexture,j,we)}}else if(M!==null&&j!==0){const we=m.get(M.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,we.__webglTexture,j)}V=-1},this.readRenderTargetPixels=function(M,F,j,K,G,ye,Ue,we=0){if(!(M&&M.isWebGLRenderTarget)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ne=m.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Ue!==void 0&&(Ne=Ne[Ue]),Ne){ae.bindFramebuffer(T.FRAMEBUFFER,Ne);try{const Oe=M.textures[we],He=Oe.format,ze=Oe.type;if(!ne.textureFormatReadable(He)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ne.textureTypeReadable(ze)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=M.width-K&&j>=0&&j<=M.height-G&&(M.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+we),T.readPixels(F,j,K,G,_e.convert(He),_e.convert(ze),ye))}finally{const Oe=B!==null?m.get(B).__webglFramebuffer:null;ae.bindFramebuffer(T.FRAMEBUFFER,Oe)}}},this.readRenderTargetPixelsAsync=async function(M,F,j,K,G,ye,Ue,we=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ne=m.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Ue!==void 0&&(Ne=Ne[Ue]),Ne)if(F>=0&&F<=M.width-K&&j>=0&&j<=M.height-G){ae.bindFramebuffer(T.FRAMEBUFFER,Ne);const Oe=M.textures[we],He=Oe.format,ze=Oe.type;if(!ne.textureFormatReadable(He))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ne.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ke=T.createBuffer();T.bindBuffer(T.PIXEL_PACK_BUFFER,Ke),T.bufferData(T.PIXEL_PACK_BUFFER,ye.byteLength,T.STREAM_READ),M.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+we),T.readPixels(F,j,K,G,_e.convert(He),_e.convert(ze),0);const at=B!==null?m.get(B).__webglFramebuffer:null;ae.bindFramebuffer(T.FRAMEBUFFER,at);const mt=T.fenceSync(T.SYNC_GPU_COMMANDS_COMPLETE,0);return T.flush(),await cg(T,mt,4),T.bindBuffer(T.PIXEL_PACK_BUFFER,Ke),T.getBufferSubData(T.PIXEL_PACK_BUFFER,0,ye),T.deleteBuffer(Ke),T.deleteSync(mt),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,F=null,j=0){const K=Math.pow(2,-j),G=Math.floor(M.image.width*K),ye=Math.floor(M.image.height*K),Ue=F!==null?F.x:0,we=F!==null?F.y:0;L.setTexture2D(M,0),T.copyTexSubImage2D(T.TEXTURE_2D,j,0,0,Ue,we,G,ye),ae.unbindTexture()};const Zh=T.createFramebuffer(),Jh=T.createFramebuffer();this.copyTextureToTexture=function(M,F,j=null,K=null,G=0,ye=null){ye===null&&(G!==0?(os("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ye=G,G=0):ye=0);let Ue,we,Ne,Oe,He,ze,Ke,at,mt;const gt=M.isCompressedTexture?M.mipmaps[ye]:M.image;if(j!==null)Ue=j.max.x-j.min.x,we=j.max.y-j.min.y,Ne=j.isBox3?j.max.z-j.min.z:1,Oe=j.min.x,He=j.min.y,ze=j.isBox3?j.min.z:0;else{const Qt=Math.pow(2,-G);Ue=Math.floor(gt.width*Qt),we=Math.floor(gt.height*Qt),M.isDataArrayTexture?Ne=gt.depth:M.isData3DTexture?Ne=Math.floor(gt.depth*Qt):Ne=1,Oe=0,He=0,ze=0}K!==null?(Ke=K.x,at=K.y,mt=K.z):(Ke=0,at=0,mt=0);const lt=_e.convert(F.format),Ve=_e.convert(F.type);let rt;F.isData3DTexture?(L.setTexture3D(F,0),rt=T.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(L.setTexture2DArray(F,0),rt=T.TEXTURE_2D_ARRAY):(L.setTexture2D(F,0),rt=T.TEXTURE_2D),T.pixelStorei(T.UNPACK_FLIP_Y_WEBGL,F.flipY),T.pixelStorei(T.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),T.pixelStorei(T.UNPACK_ALIGNMENT,F.unpackAlignment);const Je=T.getParameter(T.UNPACK_ROW_LENGTH),qt=T.getParameter(T.UNPACK_IMAGE_HEIGHT),Wi=T.getParameter(T.UNPACK_SKIP_PIXELS),Yt=T.getParameter(T.UNPACK_SKIP_ROWS),Ar=T.getParameter(T.UNPACK_SKIP_IMAGES);T.pixelStorei(T.UNPACK_ROW_LENGTH,gt.width),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,gt.height),T.pixelStorei(T.UNPACK_SKIP_PIXELS,Oe),T.pixelStorei(T.UNPACK_SKIP_ROWS,He),T.pixelStorei(T.UNPACK_SKIP_IMAGES,ze);const ft=M.isDataArrayTexture||M.isData3DTexture,Vt=F.isDataArrayTexture||F.isData3DTexture;if(M.isDepthTexture){const Qt=m.get(M),Ut=m.get(F),Ht=m.get(Qt.__renderTarget),Pa=m.get(Ut.__renderTarget);ae.bindFramebuffer(T.READ_FRAMEBUFFER,Ht.__webglFramebuffer),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,Pa.__webglFramebuffer);for(let yi=0;yi<Ne;yi++)ft&&(T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,m.get(M).__webglTexture,G,ze+yi),T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,m.get(F).__webglTexture,ye,mt+yi)),T.blitFramebuffer(Oe,He,Ue,we,Ke,at,Ue,we,T.DEPTH_BUFFER_BIT,T.NEAREST);ae.bindFramebuffer(T.READ_FRAMEBUFFER,null),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else if(G!==0||M.isRenderTargetTexture||m.has(M)){const Qt=m.get(M),Ut=m.get(F);ae.bindFramebuffer(T.READ_FRAMEBUFFER,Zh),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,Jh);for(let Ht=0;Ht<Ne;Ht++)ft?T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,Qt.__webglTexture,G,ze+Ht):T.framebufferTexture2D(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Qt.__webglTexture,G),Vt?T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,Ut.__webglTexture,ye,mt+Ht):T.framebufferTexture2D(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Ut.__webglTexture,ye),G!==0?T.blitFramebuffer(Oe,He,Ue,we,Ke,at,Ue,we,T.COLOR_BUFFER_BIT,T.NEAREST):Vt?T.copyTexSubImage3D(rt,ye,Ke,at,mt+Ht,Oe,He,Ue,we):T.copyTexSubImage2D(rt,ye,Ke,at,Oe,He,Ue,we);ae.bindFramebuffer(T.READ_FRAMEBUFFER,null),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else Vt?M.isDataTexture||M.isData3DTexture?T.texSubImage3D(rt,ye,Ke,at,mt,Ue,we,Ne,lt,Ve,gt.data):F.isCompressedArrayTexture?T.compressedTexSubImage3D(rt,ye,Ke,at,mt,Ue,we,Ne,lt,gt.data):T.texSubImage3D(rt,ye,Ke,at,mt,Ue,we,Ne,lt,Ve,gt):M.isDataTexture?T.texSubImage2D(T.TEXTURE_2D,ye,Ke,at,Ue,we,lt,Ve,gt.data):M.isCompressedTexture?T.compressedTexSubImage2D(T.TEXTURE_2D,ye,Ke,at,gt.width,gt.height,lt,gt.data):T.texSubImage2D(T.TEXTURE_2D,ye,Ke,at,Ue,we,lt,Ve,gt);T.pixelStorei(T.UNPACK_ROW_LENGTH,Je),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,qt),T.pixelStorei(T.UNPACK_SKIP_PIXELS,Wi),T.pixelStorei(T.UNPACK_SKIP_ROWS,Yt),T.pixelStorei(T.UNPACK_SKIP_IMAGES,Ar),ye===0&&F.generateMipmaps&&T.generateMipmap(rt),ae.unbindTexture()},this.initRenderTarget=function(M){m.get(M).__webglFramebuffer===void 0&&L.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?L.setTextureCube(M,0):M.isData3DTexture?L.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?L.setTexture2DArray(M,0):L.setTexture2D(M,0),ae.unbindTexture()},this.resetState=function(){I=0,U=0,B=null,ae.reset(),Le.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return An}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ze._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ze._getUnpackColorSpace()}}const Yr=window.innerWidth<768,Rt={particleCount:Yr?22e3:45e3,particleSize:Yr?1.6:1.2,textScale:Yr?.14:.22,canvasFont:'900 100px "Microsoft YaHei", sans-serif'},XS=["快乐","悲伤","喜悦","愤怒","平静","恐惧","爱","焦虑","感恩","羞愧","希望","嫉妒","自豪","孤独","兴奋","内疚","幽默","厌恶"];function $r(n,e=null){const t=e!==null?e:Rt.textScale,i=document.createElement("canvas"),r=i.getContext("2d");i.width=1024,i.height=256,r.fillStyle="black",r.fillRect(0,0,i.width,i.height),r.fillStyle="white",r.font=Rt.canvasFont,r.textAlign="center",r.textBaseline="middle",r.fillText(n,i.width/2,i.height/2);const s=r.getImageData(0,0,i.width,i.height),a=[],o=Yr?4:2;for(let l=0;l<i.height;l+=o)for(let u=0;u<i.width;u+=o)s.data[(l*i.width+u)*4]>100&&a.push({x:(u-i.width/2)*t,y:-(l-i.height/2)*t,z:0});return a}function qS(){return XS.map(n=>$r(n))}function YS(n){const e=[];for(let s=0;s<n;s++)e.push({x:(Math.random()-.5)*100,y:-150+Math.random()*30,z:(Math.random()-.5)*60,vx:(Math.random()-.5)*.2,vy:Math.random()*.5});return e}function $S(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*220;let r=Math.sqrt(Math.pow(i,2))*.5+3;Math.abs(i)>100&&(r=60*Math.random());const s=Math.random()*Math.PI*2;Math.random()>.85&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function Yu(n,e){return $r(n,Yr?.08:.12).map(r=>({x:r.x,y:r.y+e,z:r.z}))}function KS(n){const e=[];for(let t=0;t<n;t++){const i=t<n/2,r=i?-50:50;let s="glass",a=(Math.random()-.5)*110,o=28,l=Math.random()*Math.PI*2;Math.random()>.35&&a<35&&a>-50&&(s="liquid",o=Math.random()*26,a>30&&(s="foam"));let u=o*Math.cos(l),c=o*Math.sin(l),f=a;s==="glass"&&a>-15&&a<35&&Math.abs(l-(i?Math.PI:0))<.6&&(u+=i?-18:18,s="handle"),e.push({x:u+r,y:f,z:c,type:s,isLeft:i,baseX:u+r})}return e}function jS(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*200;let r=0;i>60?r=20*(100-i)/40:i>-80?r=20:r=20+(-80-i)*1.5;const s=Math.random()*Math.PI*2;i<60&&i>-80&&Math.random()>.4&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function ZS(n){const e=[],i=n-4e3,r=[{r:1,g:0,b:0},{r:1,g:.5,b:0},{r:1,g:1,b:0},{r:0,g:1,b:0},{r:0,g:1,b:1},{r:0,g:0,b:1},{r:.5,g:0,b:1}],s=900,a=-s/2;for(let o=0;o<i;o++){const l=a+Math.random()*s,c=l<0?"left":"right",f=Math.random();let h,p,_="deck";const v=-20,g=50,d=100,b=l/(s/2),A=v+d*(b*b);if(f<.65)h=v+(Math.random()-.5)*8,p=(Math.random()-.5)*g,_="deck";else if(f<.85)h=A+(Math.random()-.5)*2,p=(Math.random()>.5?1:-1)*(g/2)+(Math.random()-.5)*2,_="cable";else{const R=Math.round(l/25)*25;if(Math.abs(l-R)<4){const O=Math.random();h=v+O*(A-v),p=(Math.random()>.5?1:-1)*(g/2),_="hanger",e.push({x:R+(Math.random()-.5)*2,y:h,z:p,type:"bridge",side:R<0?"left":"right",color:r[Math.floor((R+450)/900*7)]||{r:1,g:1,b:1},baseX:R});continue}else h=v+(Math.random()-.5)*8,p=(Math.random()-.5)*g,_="deck"}const y=Math.floor((l+450)/900*7),w=Math.max(0,Math.min(6,y));e.push({x:l,y:h,z:p,type:"bridge",section:_,side:c,color:r[w],baseX:l})}for(let o=0;o<4e3;o++){const l=o<2e3?0:1,u=Math.random();let c="body",f=0,h=0,p=0;if(u<.15){const _=Math.random()*Math.PI*2,v=Math.random()*Math.PI,g=4*Math.random();f=g*Math.sin(v)*Math.cos(_),h=30+g*Math.sin(v)*Math.sin(_),p=g*Math.cos(v),c="head"}else u<.5?(f=(Math.random()-.5)*6,h=14+Math.random()*14,p=(Math.random()-.5)*4,c="torso"):u<.75?(f=(Math.random()>.5?-2.5:2.5)+(Math.random()-.5)*2,h=Math.random()*14,p=(Math.random()-.5)*2.5,c="leg"):(f=(Math.random()>.5?-5:5)+(Math.random()-.5)*2,h=16+Math.random()*10,p=(Math.random()-.5)*2,c="arm");e.push({x:0,y:-1e3,z:0,type:"man",manIndex:l,part:c,localX:f,localY:h,localZ:p})}return e}const wa=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},or=3e3,JS={__name:"ParticleScene",props:{currentShape:String,triggerState:Number,currentTheme:String,isRunning:Boolean},emits:["firework-tick"],setup(n,{emit:e}){const t=n,i=e,r=Zt(null);let s,a,o,l,u,c=[],f,h=0,p=0,_=[],v=[],g=[],d=[],b=[],A=[],y=0,w=[],D=[],R=[],O=[],x=[],E=[],I=0,U=!1;const B=()=>{t.isRunning&&(s=new Ug,s.fog=new lc(0,.002),a=new sn(75,window.innerWidth/window.innerHeight,.1,1e3),a.position.z=140,o=new WS({antialias:!0,alpha:!0}),o.setSize(window.innerWidth,window.innerHeight),o.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.value&&(r.value.innerHTML="",r.value.appendChild(o.domElement)),V(),z())},V=()=>{u=new xn;const ce=Rt.particleCount,ie=new Float32Array(ce*3),le=new Float32Array(ce*3);c=new Float32Array(ce*3);for(let he=0;he<ce;he++)ie[he*3]=(Math.random()-.5)*200,ie[he*3+1]=-1e3,ie[he*3+2]=(Math.random()-.5)*200,c[he*3]=ie[he*3],c[he*3+1]=ie[he*3+1],c[he*3+2]=ie[he*3+2],le[he*3]=1,le[he*3+1]=1,le[he*3+2]=1;u.setAttribute("position",new ln(ie,3)),u.setAttribute("color",new ln(le,3));const Ie=new Yg().load("https://threejs.org/examples/textures/sprites/spark1.png"),me=new Oh({size:Rt.particleSize,map:Ie,transparent:!0,opacity:.9,vertexColors:!0,blending:Fo,depthWrite:!1});l=new zg(u,me),s.add(l),q()},q=()=>{if(!u||!t.isRunning)return;h=0,p=0,y=0;let ce=[];const ie=Rt.particleCount;for(let le=0;le<ie;le++)c[le*3]=(Math.random()-.5)*200,c[le*3+1]=-1e3,c[le*3+2]=0;if(t.currentShape==="fireworks")x.length===0&&(x=YS(or)),E.length===0&&(E=qS()),U=!1,I=0,i("firework-tick",{idx:0,total:18,time:0}),ce=x;else if(t.currentShape==="hourglass"){if(_.length===0){_=$S(ie*.6),v=Yu("2025",60),g=Yu("今年辛苦啦",-60);const le=ie-_.length;d=new Float32Array(le);for(let Ie=0;Ie<le;Ie++)d[Ie]=Math.random()*3.5}ce=_}else t.currentShape==="beer"?(b.length===0&&(b=KS(ie*.9),A=$r("2025 有你相伴")),ce=b):t.currentShape==="rocket"?(w.length===0&&(w=jS(ie),D=$r("2026新年快乐")),ce=w):t.currentShape==="bridge"&&(R=ZS(ie),O=$r("2026 与你同行"),ce=R);for(let le=0;le<ce.length;le++){const Ie=le*3;c[Ie]=ce[le].x,c[Ie+1]=ce[le].y,c[Ie+2]=ce[le].z}W()},W=()=>{if(!u)return;const ce=u.attributes.color;for(let ie=0;ie<Rt.particleCount;ie++){let le=1,Ie=1,me=1;if(t.currentTheme==="warm"?(le=1,Ie=.8,me=.4):(le=.2,Ie=.8,me=1),t.currentShape==="beer"&&ie<b.length&&b[ie].type==="liquid"&&(le=1,Ie=.6,me=0),t.currentShape==="bridge"&&ie<R.length&&R[ie].type==="bridge"){const he=R[ie].color;le=he.r,Ie=he.g,me=he.b}ce.setXYZ(ie,le,Ie,me)}ce.needsUpdate=!0},z=()=>{if(f=requestAnimationFrame(z),!u)return;const ce=u.attributes.position.array,ie=u.attributes.color.array;if(h+=.015,t.currentShape==="fireworks"){for(let me=0;me<or;me++){const he=me*3;if(me<x.length){const xe=x[me];c[he]=xe.x+(Math.random()-.5)*2,c[he+1]=xe.y+Math.random()*5,c[he+2]=xe.z+(Math.random()-.5)*2,ie[he]=1,ie[he+1]=.6,ie[he+2]=.1}}if(t.triggerState>=1){U||(U=!0,I=Date.now());const he=(Date.now()-I)/1e3,xe=5,Y=18,Q=Math.floor(he/xe),ge=he%xe;if(Q<Y){i("firework-tick",{idx:Q+1,total:Y,time:(xe-ge).toFixed(1)});const Be=E[Q%18];for(let be=or;be<Rt.particleCount;be++){const De=be*3,C=be-or;if(ge<1){const P=ge/1,H=P*20+C*.05,te=5*Math.sin(P*Math.PI);c[De]=Math.cos(H)*te,c[De+1]=-150+P*280,c[De+2]=Math.sin(H)*te,ie[De]=1,ie[De+1]=.9,ie[De+2]=.6}else if(ge<1.5){if(ge<1.1){const P=Math.acos(-1+2*Math.random()),H=Math.sqrt(Rt.particleCount*Math.PI)*P,te=120+Math.random()*60;c[De]=te*Math.sin(P)*Math.cos(H),c[De+1]=100+te*Math.sin(P)*Math.sin(H),c[De+2]=te*Math.cos(P),ie[De]=Math.random(),ie[De+1]=Math.random(),ie[De+2]=1}}else if(ge<2)c[De+1]-=3,c[De]*=.97,c[De+2]*=.97;else if(ge<4)if(C<Be.length){const P=Be[C];c[De]+=(P.x-c[De])*.15,c[De+1]+=(P.y+50-c[De+1])*.15,c[De+2]+=(P.z-c[De+2])*.15,["快乐","喜悦","爱"].includes(Rt.emotionWords?.[Q%18])?(ie[De]=1,ie[De+1]=.4,ie[De+2]=.2):(ie[De]=.2,ie[De+1]=.3,ie[De+2]=.9)}else c[De+1]-=5;else c[De]*=1.05,c[De+1]+=3}u.attributes.color.needsUpdate=!0}}else for(let me=or;me<Rt.particleCount;me++)c[me*3]=0,c[me*3+1]=-1e3}else if(t.currentShape==="hourglass"){t.triggerState===1?p+=.015:p=0;const me=.005;for(let he=0;he<Rt.particleCount;he++){const xe=he*3;if(he<_.length){const Y=c[xe],Q=c[xe+2],ge=Math.atan2(Q,Y)+me,Be=Math.sqrt(Y*Y+Q*Q);c[xe]=Be*Math.cos(ge),c[xe+2]=Be*Math.sin(ge)}else{const Y=he-_.length,Q=v[Y%v.length],ge=g[Y%g.length];if(t.triggerState===0)Q&&(c[xe]+=(Q.x-c[xe])*.15,c[xe+1]+=(Q.y-c[xe+1])*.15,c[xe+2]+=(Q.z-c[xe+2])*.15);else{const Be=d[Y%d.length],be=p;if(be<Be)Q&&(c[xe]=Q.x,c[xe+1]=Q.y,c[xe+2]=Q.z);else if(be<Be+1.2){const De=(be-Be)/1.2;if(De<.5){const C=De*2;c[xe]=Q.x*(1-C),c[xe+1]=Q.y*(1-C),c[xe+2]=Q.z*(1-C)}else{const C=(De-.5)*2;c[xe]=ge.x*C,c[xe+1]=ge.y*C,c[xe+2]=ge.z*C}c[xe]+=(Math.random()-.5)*2}else ge&&(c[xe]=ge.x,c[xe+1]=ge.y,c[xe+2]=ge.z)}}}}else if(t.currentShape==="beer"){t.triggerState>=1?y+=2:y=0;for(let me=0;me<Rt.particleCount;me++){const he=me*3;if(me<b.length){const xe=b[me];let Y=xe.x;if(t.triggerState>=1){const Q=Math.min(25,y*.8);Y+=xe.isLeft?Q:-Q,Q>=25&&(Y+=(Math.random()-.5)*2)}c[he]=Y,c[he+1]=xe.y}else if(t.triggerState>=1&&y>100&&A.length>0){const xe=A[(me-b.length)%A.length];c[he]+=(xe.x-c[he])*.1,c[he+1]+=(xe.y-60-c[he+1])*.1,c[he+2]+=(xe.z-c[he+2])*.1}else c[he]=0,c[he+1]=-1e3}}else if(t.currentShape==="rocket"){if(t.triggerState===1)for(let me=0;me<Rt.particleCount;me++)c[me*3+1]+=12;else if(t.triggerState===2)for(let me=0;me<Rt.particleCount;me++){const he=me*3;if(me<D.length){const xe=D[me];c[he]=xe.x,c[he+1]=xe.y,c[he+2]=xe.z}else c[he]*=1.1}}else if(t.currentShape==="bridge"){let me=t.triggerState===0?180:0;for(let he=0;he<Rt.particleCount;he++){const xe=he*3;if(he<R.length){const Y=R[he];if(Y.type==="bridge"){let Q=Y.baseX+(Y.side==="left"?-me:me);c[xe]=Q,c[xe+1]=Y.y,c[xe+2]=Y.z}else if(Y.type==="man")if(t.triggerState===2){const ge=h*60%1100+-550;let Be=Math.abs(Math.sin(h*15))*3;c[xe]=ge+Y.localX,c[xe+1]=-20+Y.localY+Be,c[xe+2]=Y.localZ}else c[xe]=0,c[xe+1]=-1e3}else if(t.triggerState===2&&O.length>0){const Y=O[(he-R.length)%O.length];c[xe]=Y.x,c[xe+1]=Y.y-120,c[xe+2]=Y.z}else c[xe]=0,c[xe+1]=-1e3}}const le=.18,Ie=t.currentShape==="fireworks"?or:0;for(let me=Ie;me<Rt.particleCount;me++){const he=me*3;ce[he]+=(c[he]-ce[he])*le,ce[he+1]+=(c[he+1]-ce[he+1])*le,ce[he+2]+=(c[he+2]-ce[he+2])*le}u.attributes.position.needsUpdate=!0,o.render(s,a)};pr(()=>t.isRunning,ce=>{ce&&B()}),pr(()=>t.currentShape,q),pr(()=>t.currentTheme,W),Yl(()=>{window.addEventListener("resize",ee)}),xa(()=>{cancelAnimationFrame(f),window.removeEventListener("resize",ee)});const ee=()=>{a&&o&&(a.aspect=window.innerWidth/window.innerHeight,a.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight))};return(ce,ie)=>(gn(),Cn("div",{ref_key:"canvasContainer",ref:r,class:"canvas-wrapper"},null,512))}},QS=wa(JS,[["__scopeId","data-v-289a0936"]]),eM={id:"ui-container"},tM={class:"panel-card"},nM={class:"year-group"},iM={class:"year-item"},rM={key:0,class:"hint-wrap"},sM={class:"sub-hint"},aM={class:"year-item"},oM={key:0,class:"hint-wrap"},lM={class:"sub-hint"},cM={__name:"ControlPanel",props:{currentYear:String,sceneIndex:Number},emits:["select-year"],setup(n){const e=n,t=Zl(()=>{if(e.currentYear==="2025"){if(e.sceneIndex===0)return"✊握拳: 重置流沙";if(e.sceneIndex===1)return"✌️剪刀手: 18连发烟花";if(e.sceneIndex===2)return"✊握拳: 干杯碰撞"}else{if(e.sceneIndex===0)return"🖐️上滑: 发射火箭";if(e.sceneIndex===1)return"✊握拳: 断桥重连"}return"互动就绪"});return(i,r)=>(gn(),Cn("div",eM,[pt("div",tM,[pt("div",nM,[pt("div",iM,[pt("button",{class:xr(["year-btn y25",{active:n.currentYear==="2025"}]),onClick:r[0]||(r[0]=s=>i.$emit("select-year","2025"))}," 2025 ",2),n.currentYear==="2025"?(gn(),Cn("div",rM,[r[2]||(r[2]=pt("div",{class:"main-hint"},"👋 左 → 右 切页",-1)),pt("div",sM,fr(t.value),1)])):ts("",!0)]),r[4]||(r[4]=pt("div",{class:"divider"},null,-1)),pt("div",aM,[pt("button",{class:xr(["year-btn y26",{active:n.currentYear==="2026"}]),onClick:r[1]||(r[1]=s=>i.$emit("select-year","2026"))}," 2026 ",2),n.currentYear==="2026"?(gn(),Cn("div",oM,[r[3]||(r[3]=pt("div",{class:"main-hint"},"👋 右 ← 左 切页",-1)),pt("div",lM,fr(t.value),1)])):ts("",!0)])])])]))}},uM=wa(cM,[["__scopeId","data-v-a36f4ce9"]]);function $u(n){return new Promise((e,t)=>{if(document.querySelector(`script[src="${n}"]`)){e();return}const i=document.createElement("script");i.src=n,i.async=!0,i.crossOrigin="anonymous",i.onload=()=>e(),i.onerror=()=>t(new Error(`Script load error: ${n}`)),document.head.appendChild(i)})}const fM={class:"camera-wrapper"},hM=3,dM={__name:"CameraInput",props:{isActive:Boolean},emits:["status-change","camera-error","gesture","hand-x","hand-y","lock-swipe"],setup(n,{expose:e,emit:t}){const i=n,r=t,s=Zt(null),a=Zt(null);let o=null,l=null,u=-1,c="NONE",f=0;const h=async()=>{try{r("status-change","启动视觉引擎..."),await Promise.all([$u("https://cdn.jsdelivr.net/npm/@mediapipe/hands/hands.js"),$u("https://cdn.jsdelivr.net/npm/@mediapipe/drawing_utils/drawing_utils.js")]);const d=window.Hands;o=new d({locateFile:A=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${A}`}),o.setOptions({maxNumHands:1,modelComplexity:0,minDetectionConfidence:.5,minTrackingConfidence:.5}),o.onResults(g);let b;try{b=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user",width:{ideal:640},height:{ideal:480}}})}catch(A){console.warn("方案A失败，尝试方案B...",A);try{b=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user"}})}catch(y){console.warn("方案B失败，尝试方案C...",y);try{b=await navigator.mediaDevices.getUserMedia({video:!0})}catch(w){throw w}}}p(b)}catch(d){console.error("Camera Init Error:",d);let b="无法开启摄像头";d.name==="NotAllowedError"&&(b="请允许访问摄像头"),r("camera-error",b)}},p=d=>{s.value&&(s.value.srcObject=d,s.value.onloadedmetadata=()=>{s.value.play().catch(b=>console.error("Auto-play failed:",b)),a.value.width=s.value.videoWidth,a.value.height=s.value.videoHeight,r("status-change","Ready"),_()})},_=async()=>{i.isActive&&(s.value&&s.value.readyState>=2&&s.value.currentTime!==u&&(u=s.value.currentTime,o&&await o.send({image:s.value})),l=requestAnimationFrame(_))},v=(d,b)=>Math.sqrt(Math.pow(d.x-b.x,2)+Math.pow(d.y-b.y,2)),g=d=>{if(!a.value)return;const b=a.value.getContext("2d"),A=a.value.width,y=a.value.height;b.save(),b.clearRect(0,0,A,y),b.translate(A,0),b.scale(-1,1),b.drawImage(d.image,0,0,A,y);let w="NONE",D=-1;if(d.multiHandLandmarks&&d.multiHandLandmarks.length>0){const R=d.multiHandLandmarks[0];window.drawConnectors&&(window.drawConnectors(b,R,window.HAND_CONNECTIONS,{color:"#00d2ff",lineWidth:2}),window.drawLandmarks(b,R,{color:"#ff0000",lineWidth:1,radius:2})),D=R[0].x,r("hand-x",D),r("hand-y",R[0].y);const O=R[0],x=(q,W)=>v(O,R[q])>v(O,R[W])*1.1,E=(q,W)=>v(O,R[q])<v(O,R[W]),I=x(8,6),U=x(12,10),B=E(16,14),V=E(20,18);I&&U&&B&&V?w="VICTORY":!I&&!U&&B&&V?w="FIST":I&&U&&!B&&!V&&(w="PALM")}w===c?(f++,f>hM&&(r("gesture",w),r("lock-swipe",w==="VICTORY"||w==="FIST"))):(f=0,c=w,(w==="NONE"||w==="PALM")&&r("lock-swipe",!1)),b.restore()};return e({startCamera:h}),xa(()=>{s.value?.srcObject&&s.value.srcObject.getTracks().forEach(d=>d.stop()),cancelAnimationFrame(l),o&&o.close()}),(d,b)=>(gn(),Cn("div",fM,[pt("video",{ref_key:"inputVideo",ref:s,playsinline:"","webkit-playsinline":"",muted:"",style:{display:"none"}},null,512),Xd(pt("canvas",{ref_key:"previewCanvas",ref:a,class:"video-preview"},null,512),[[cm,n.isActive]])]))}},pM=wa(dM,[["__scopeId","data-v-2133c7e0"]]),mM={key:0,id:"overlay"},gM={__name:"IntroOverlay",props:{visible:Boolean,showGuide:Boolean},emits:["select-mode"],setup(n){return(e,t)=>(gn(),Cn(rn,null,[n.visible?(gn(),Cn("div",mM,[t[2]||(t[2]=pt("h2",{class:"title"},"Lynx",-1)),t[3]||(t[3]=pt("div",{class:"msg-box"},"请选择交互方式",-1)),pt("button",{id:"btn-cam",class:"action-btn",onClick:t[0]||(t[0]=i=>e.$emit("select-mode","camera"))},"开启摄像头"),pt("button",{id:"btn-touch",class:"action-btn",onClick:t[1]||(t[1]=i=>e.$emit("select-mode","touch"))},"触屏 / 鼠标模式")])):ts("",!0),pt("div",{id:"touch-guide",class:xr({show:n.showGuide})},"⟵ 滑动屏幕控制扩散 ⟶",2)],64))}},_M=wa(gM,[["__scopeId","data-v-da6579d6"]]),xM={class:"app-container"},vM={key:0,class:"firework-hud"},SM={class:"hud-row"},MM={class:"hud-row"},EM={key:0,class:"status-tip"},yM={__name:"App",setup(n){const e=Zt("2025"),t=Zt(0),i=Zt("warm"),r=Zt(1),s=Zt(""),a=Zt(!0),o=Zt(!1),l=Zt(null),u=Zt(!1);let c=null,f=null;const h=Zt({idx:0,total:18,time:0}),p={2025:["hourglass","fireworks","beer"],2026:["rocket","bridge"]},_=Zl(()=>p[e.value][t.value]);let v=-1,g=-1,d=!1;const b=V=>{a.value=!1,setTimeout(()=>{o.value=!0},100),V==="camera"&&l.value.startCamera()},A=()=>{c&&(clearTimeout(c),c=null),f&&(clearTimeout(f),f=null),e.value==="2025"&&t.value===0?r.value=1:r.value=0,d=!1,u.value=!1,s.value="",h.value={idx:0,total:18,time:0}},y=V=>{e.value!==V&&(e.value=V,t.value=0,i.value=V==="2025"?"warm":"cyber",A())},w=V=>{_.value==="fireworks"&&r.value===1&&(h.value=V)},D=V=>{if(d||u.value){v=V;return}if(v===-1){v=V;return}const q=V-v;v=V;const W=.04;(e.value==="2025"&&q>W||e.value==="2026"&&q<-W)&&R()},R=()=>{const V=p[e.value].length,q=(t.value+1)%V;t.value=q,A(),s.value="切换场景...",d=!0,setTimeout(()=>{d=!1,s.value=""},1e3)},O=V=>{if(d||r.value!==0)return;if(g===-1){g=V;return}const q=V-g;g=V,q<-.05&&_.value==="rocket"&&I(2e3)};let x=0;const E=V=>{if(_.value==="hourglass"){V==="FIST"?(x++,x>3&&(x=0,r.value=0,s.value="时光重置")):(V==="NONE"||V==="PALM")&&r.value===0&&setTimeout(()=>{r.value=1,s.value=""},500);return}d||(_.value==="fireworks"&&V==="VICTORY"&&r.value===0?(x++,x>3&&(x=0,I(0))):_.value==="beer"&&V==="FIST"&&r.value===0?(x++,x>5&&(x=0,I(4e3))):_.value==="bridge"&&V==="FIST"&&r.value===0?(x++,x>5&&(x=0,I(0))):x>0&&x--)},I=V=>{d=!0,r.value=1,s.value="特效触发!",c&&clearTimeout(c),_.value==="fireworks"?c=setTimeout(()=>{r.value===1&&U()},92e3):_.value==="bridge"?(s.value="桥梁合拢中...",f=setTimeout(()=>{r.value===1&&(r.value=2,s.value="与你同行",c=setTimeout(()=>{r.value===2&&U()},2e4))},2500)):V>0&&(c=setTimeout(()=>{r.value===1&&(r.value=2,setTimeout(()=>{U()},3e3))},V))},U=()=>{r.value=0,d=!1,s.value="",u.value=!1},B=V=>{s.value=V};return(V,q)=>(gn(),Cn("div",xM,[bt(QS,{currentShape:_.value,currentTheme:i.value,triggerState:r.value,isRunning:o.value,onFireworkTick:w},null,8,["currentShape","currentTheme","triggerState","isRunning"]),bt(im,{name:"fade"},{default:Af(()=>[e.value==="2025"&&t.value===1&&r.value>=1?(gn(),Cn("div",vM,[pt("div",SM,[q[2]||(q[2]=pt("span",{class:"label"},"发射进度:",-1)),Io(" "+fr(h.value.idx)+" / 18",1)]),pt("div",MM,[q[3]||(q[3]=pt("span",{class:"label"},"下轮倒计时:",-1)),Io(" "+fr(h.value.time)+"s",1)])])):ts("",!0)]),_:1}),bt(pM,{ref_key:"cameraInputRef",ref:l,isActive:"",onStatusChange:q[0]||(q[0]=W=>s.value=W),onCameraError:B,onHandX:D,onHandY:O,onGesture:E,onLockSwipe:q[1]||(q[1]=W=>u.value=W)},null,512),bt(uM,{currentYear:e.value,sceneIndex:t.value,onSelectYear:y},null,8,["currentYear","sceneIndex"]),bt(_M,{visible:a.value,onSelectMode:b},null,8,["visible"]),s.value?(gn(),Cn("div",EM,fr(s.value),1)):ts("",!0)]))}};Am(yM).mount("#app");
