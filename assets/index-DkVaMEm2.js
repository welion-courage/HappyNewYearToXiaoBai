...
`)+`
`+d);const C=y+g+a,b=y+d+o,R=Fu(r,r.VERTEX_SHADER,C),D=Fu(r,r.FRAGMENT_SHADER,b);r.attachShader(v,R),r.attachShader(v,D),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function P(I){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(v)||"",N=r.getShaderInfoLog(R)||"",Y=r.getShaderInfoLog(D)||"",Z=U.trim(),X=N.trim(),V=Y.trim();let ee=!0,se=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(ee=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,R,D);else{const re=Bu(r,R,"vertex"),fe=Bu(r,D,"fragment");Qe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
